SpPaKpiPBC2UserView = Ext.extend(Ext.Panel, {
	...
	initComponents : function() {
		...
		this.store = new Ext.data.JsonStore({
			url : __ctxPath + "/shop/listSpPaKpiPBC2User.do",
		...
		this.gridPanel.addListener("rowdblclick", function (f, d, g) {
			f.getSelectionModel().each(function(e) {
				new SpAuthorizePbcForm({
					pbcId : e.data.id,
					from : "SpPaKpiPBC2UserView"
				}).show();
			});
		});
