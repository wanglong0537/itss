SpPaPerformanceindexscoreForm1 = Ext.extend(Ext.Window, {
	formPanel : null,
	constructor : function(a) {
		...
		Ext.apply(this, a);
		this.initComponents();
		SpPaPerformanceindexscoreForm1.superclass.constructor.call(this, {
			id : "SpPaPerformanceindexscoreForm1Win",
			layout : "fit",
	...
	initComponents : function() {
		this.formPanel = new Ext.FormPanel({
			...
			border : false,
			id : "SpPaPerformanceindexscoreForm1",
			defaults : {
				anchor : "98%,98%"
			},
			...
			items : [
				{
					...
					name : "spPaPerformanceindexscore.pi.id",
					id : "piIdForm1",
					xtype : "hidden",
					value : this.piId
				}, {
