DraftHrPaKpipbcView = Ext.extend(Ext.Panel, {
	...
	initComponents : function() {
		...
		this.store = new Ext.data.JsonStore({
			url : __ctxPath + "/kpi/listHrPaKpipbc.do?Q_publishStatus_N_EQ=0",
	...
	delHrPaKpipbc : function() {
		var e = Ext.getCmp("DraftHrPaKpipbcGrid");
...
DraftHrPaKpipbcView.remove = function(b) {
	var a = Ext.getCmp("DraftHrPaKpipbcGrid");
