...
/*  90 */     List<ArchivesAttend> list = this.archivesAttendService.getAll(filter);
/*     */ 
/*  92 */     Type type = new TypeToken<List<ArchivesAttend>>() {  }
/*  92 */     .getType();
/*  93 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
/*  94 */       .append(filter.getPagingBean().getTotalItems()).append(",result:");
/*     */ 
...
/*     */   public String get()
/*     */   {
/* 127 */     ArchivesAttend archivesAttend = (ArchivesAttend)this.archivesAttendService.get(this.attendId);
/*     */ 
...
/*     */   public String save()
/*     */   {
/* 142 */     String archivesStatus = getRequest().getParameter("archivesStatus");
/* 143 */     this.archives = ((Archives)this.archivesService.get(this.archives.getArchivesId()));
/* 144 */     if (StringUtils.isNotEmpty(archivesStatus)) {
/* 145 */       this.archives.setStatus(Short.valueOf(Short.parseShort(archivesStatus)));
/*     */     }
...
/* 151 */     this.archivesAttend.setFullname(ContextUtil.getCurrentUser().getFullname());
/* 152 */     this.archivesAttend.setExecuteTime(new Date());
/* 153 */     this.archivesAttendService.save(this.archivesAttend);
/*     */ 
/* 155 */     setJsonString("{success:true,attendId:" + this.archivesAttend.getAttendId() + "}");
/* 156 */     return "success";
/*     */   }
/*     */ 
/*     */   public String proof()
...
/* 166 */     Archives archives = (Archives)this.archivesService.get(new Long(archivesId));
...
/* 208 */     this.archivesAttend.setFullname(ContextUtil.getCurrentUser().getFullname());
 ...
 * Qualified Name:     com.xpsoft.oa.action.archive.ArchivesAttendAction
