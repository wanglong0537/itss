...
/*    */ import com.xpsoft.core.service.DanpinGenericService;
...
/*    */ 
/*    */ public class DanpinGenericServiceImpl<T, PK extends Serializable>
/*    */   implements DanpinGenericService<T, PK>
/*    */ {
/* 19 */   protected Log logger = LogFactory.getLog(DanpinGenericServiceImpl.class);
/*    */ 
/* 21 */   protected DanpinGenericDao<T, Serializable> dao = null;
/*    */ 
/*    */   public void setDao(DanpinGenericDao dao) {
/* 24 */     this.dao = dao;
/*    */   }
/*    */ 
/*    */   public DanpinGenericServiceImpl(DanpinGenericDao dao) {
/* 28 */     this.dao = dao;
/*    */   }
/*    */ 
/*    */   public T get(PK id) {
