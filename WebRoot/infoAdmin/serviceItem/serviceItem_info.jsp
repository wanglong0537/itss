...
<head>
  <title>欢迎使用IT服务系统</title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/common.js"></script>   
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/serviceItem/serviceItem_info.js"></script>
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/serviceItem/sci_process_list.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   if("${param.dataId}"==""){
	     var pageTemplates = new PageTemplates({dataId:"0"});
	   		...
	   		var pageTemplates = new PageTemplates({dataId:'${param.dataId}'});
	   }
