	...
	initComponent : function() {
		var searchType = new Ext.form.ComboBox({
			...
			store : new Ext.data.JsonStore({
				url : webContext
						+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.service.entity.ServiceItemType',
				fields : ['id', 'name'],
				listeners : {
		...
		var searchStatus = new Ext.form.ComboBox({
			...
			store : new Ext.data.JsonStore({
				url : webContext
						+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.service.entity.ServiceStatus',
				fields : ['id', 'name'],
				listeners : {
					beforeload : function(store, opt) {
