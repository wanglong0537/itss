...
function findColumnsByTable(){ 
   ...
   Ext.Ajax.request({
      url: serverPath+"/infoAdmin/serviceItemUserTableColumn.do?methodCall=findColumnsByTable", 
      params:{
...
function saveColumn(){
  ...
  var referencedTable = document.editForm.referencedTable;
  var referencedTableId = referencedTable[referencedTable.selectedIndex].value;
  var referencedTableKeyColumn = document.editForm.referencedTableKeyColumn;
  var referencedTableKeyColumnId = referencedTableKeyColumn[referencedTableKeyColumn.selectedIndex].value;
  var referencedTableValueColumn = document.editForm.referencedTableValueColumn;
  var referencedTableValueColumnId = referencedTableValueColumn[referencedTableValueColumn.selectedIndex].value;
  var referencedTableParentColumn = document.editForm.referencedTableParentColumn;
  var referencedTableParentColumnId = referencedTableParentColumn[referencedTableParentColumn.selectedIndex].value;
...
<TABLE cellSpacing=1 cellPadding=3 width="100%" bgColor=#6298e1 border=0 height="56">
  ...
  <TR>
    <TD noWrap height=24><FONT color=#ffffff><IMG height=18 
      ...
      border=0>&nbsp;<STRONG>服务项及其对应主表管理</STRONG></FONT></TD>
  </TR>
  <TR>
    <TD noWrap align=middle bgColor=#ebf2f9 height=24>
    服务项需求表名称：${smt.tableCnName }
    </TD></TR></TBODY></TABLE><BR>
 <form action="${pageContext.request.contextPath}/infoAdmin/serviceItemUserTableColumn.do?methodCall=save" method=post  name="editForm" id="editForm">
字段属性
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="40%" bgcolor="#EFF3FF">
      ...
      <input name="serviceItem"  id="serviceItem"   type="hidden" value="${requestScope.serviceItem}">
      <input name="siut"  id="siut"   type="hidden" value="${requestScope.siut}">
