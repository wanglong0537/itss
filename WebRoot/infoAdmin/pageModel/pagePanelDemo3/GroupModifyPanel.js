...
GroupModifyPanel =Ext.extend(Ext.Panel, {
		title: '页面面板关系',
...
//           }
           ...
           var m = Ext.MessageBox.confirm("删除提示","是否真的删除,一旦删除不可恢复!",function(re){
               if(re=="yes"){
                   Ext.Ajax.request({
                    url:webContext+'/pageModel/pageGroupPanelManage.do?methodCall=toPageGroupPanelTableRemove',	
                       params:{
                           'ids':ids
                       },
                       mothod:'POST',
					...
					if(record.dirty){
						...
						Ext.Ajax.request({
							//url: 'test/TableColumnList.action?id='+id,
					         ...
					         url:webContext+'/pageModel/pageGroupPanelManage.do?methodCall=toPageGroupTableSave',				         
               				 method:"POST",
               				 params:{
               				 	'price' : unicode(price),
               				 	'ppId' : unicode(ppId)
...
//					alert("非中文=="+value3);
		...
		validateedit:function(obj){
			...
			if(obj.field=="parentPanelTable"&&obj.originalValue!=obj.value){
				...
				Ext.Ajax.request({
                    url:webContext+'/pageModel/pageGroupPanelManage.do?methodCall=findPrimaryKeyColumnID',	
                     method:"POST",
                    params:{
                           'parentPanelTable':unicode(parentPanelTable)
                       },
	...
	//*******************************************	
        initComponent : function(){ 
        	var combostore = new Ext.data.JsonStore({
										url:webContext+'/pageModel/pageGroupPanelManage.do?methodCall=findAllPagePanel',
										fields:['code','name'],
				...
				this.foreignstore = new Ext.data.JsonStore({
										url:webContext+'/pageModel/pageGroupPanelManage.do?methodCall=findAllMainTable',
										fields:['code','name'],
										totalProperty:"rowCount",
										root:"data"
										}
					...
					this.foreignColstore = new Ext.data.JsonStore({				
						                url:webContext+'/pageModel/pageGroupPanelManage.do?methodCall=findAllForeignCol',
										fields:['code','name'],
										totalProperty:"rowCount",
										root:"data"
										}
			...
			var combostore2 = new Ext.data.JsonStore({
				...
				this.foreignstore2 = new Ext.data.JsonStore({
										url:webContext+'/pageModel/pageGroupPanelManage.do?methodCall=findAllMainTable2',
										fields:['code','name'],
										totalProperty:"rowCount",
										root:"data"
										}
					...
					this.foreignColstore2 = new Ext.data.JsonStore({
						                id:'foreignColstore2',
						                url:webContext+'/pageModel/pageGroupPanelManage.do?methodCall=findPrimaryKeyColumn',
										fields:['code','name'],
										totalProperty:"rowCount",
										root:"data"
										}
           ...
           this.cm = new Ext.grid.ColumnModel([csm,{
                        ...
                        editor: new Ext.form.ComboBox({                        
						    		name:"pageGroupPanelTable.subPagePanel",
						    		id:"combox1id",
						    		displayField:'name',
						    		valueField:"code",
						    		hiddenName:"name",
                        ...
                        dataIndex: "subPanelTable",
                         editor: new Ext.form.ComboBox({                        
						    		name:"pageGroupPanelTable.subPanelTable",
						    		id:"combox2id",
						    		displayField:'name',
						    		valueField:"code",
						    		hiddenName:"name",
                        ...
                        editor: new Ext.form.ComboBox({                        
						    		name:"pageGroupPanelTable.subPanelTableFColumn",
						    		id:"combox3id",
						    		displayField:'name',
						    		valueField:"code",
						    		hiddenName:"name", 
                        ...
                        editor: new Ext.form.ComboBox({                        
						    		name:"pageGroupPanelTable.parentPagePanel",
						    		id:"combox4id",
						    		displayField:'name',
						    		valueField:"code",
						    		hiddenName:"name",
...
//				        var store = this.foreignColstore2;
                       ...
                       editor: new Ext.form.ComboBox({                        
						    		name:"pageGroupPanelTable.parentPanelTable",
						    		id:"combox5id",
						    		displayField:'name',
						    		valueField:"code",
						    		hiddenName:"name",
                        ...
                        editor: new Ext.form.ComboBox({                        
						    		name:"pageGroupPanelTable.parentPanelTablePColumn",
						    		id:"combox6id",
						    		displayField:'name',
						    		valueField:"code",
						    		hiddenName:"name",
          ...
          GroupModifyPanel.superclass.initComponent.call(this);
          
           this.store = new Ext.data.JsonStore({
                url:webContext+'/pageModel/pageGroupPanelManage.do?methodCall=toPageGroupList&ppId='+ppId,
                root:"data",
                totalProperty:"rowCount",
                remoteSort:false,  
                timeout:3000000,
