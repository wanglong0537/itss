...
<table width="98%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
 ...
 <tr >
  ...
  <tr>
    ...
    <tr>
    <td width="11%" align="center" bgcolor="#EFF3FF">是否为分组面板</td>
    <td width="36%" bgcolor="#EFF3FF">
	     <select name="groupFlag"  class="textfield" style="width:100px;">
        <option value="0" ${empty pp.groupFlag or pp.groupFlag eq 0?' selected':''}>否</option>
        <option value="1" ${pp.groupFlag eq 1?' selected':''}>是</option>
      </select>
