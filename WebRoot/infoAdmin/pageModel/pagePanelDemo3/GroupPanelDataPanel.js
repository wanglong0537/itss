									...
									buttons:[
					        	       {	xtype:'button',
					        		        handler:function(){
								        		Ext.Ajax.request({
													//调用action中存储的方法。												
													url: webContext+'/pageModel/pageGroupPanelManage.do?methodCall=modifyAndSavePanelMessage&clazz=com.digitalchina.info.appframework.pagemodel.entity.PageModelPanel&panelId='+node.id,
