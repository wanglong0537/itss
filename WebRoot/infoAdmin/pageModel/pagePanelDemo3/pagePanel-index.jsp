...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/pageModel/pagePanelDemo3/pagePanel-index.js"></script>
	<style type="text/css">
	html, body {
