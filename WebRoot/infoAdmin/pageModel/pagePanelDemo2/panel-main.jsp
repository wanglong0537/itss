...
<title>template</title>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/pageModel/pagePanelDemo2/PanelDataPanel.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/pageModel/pagePanelDemo2/ColumnDataPanel.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/pageModel/pagePanelDemo2/PanelComponent.js"></script>
