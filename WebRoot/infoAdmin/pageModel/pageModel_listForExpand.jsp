...
function loadNewTables(){ 
    var serverPath = "${pageContext.request.contextPath}/pageModel/pageModelExpandManage.do?methodCall=toPageModelEditForm";
...
<TABLE cellSpacing=1 cellPadding=3 width="100%" bgColor=#6298e1 border=0>
  ...
  <TR>
    <TD noWrap height=24><FONT color=#ffffff><IMG height=18 
      ...
      border=0>&nbsp;<STRONG>页面模型管理：查询，添加、修改页面模型</STRONG></FONT></TD>
  </TR>
    <TR>
  ...
  <FORM name="formSearch" action="${pageContext.request.contextPath}/pageModel/pageModelExpandManage.do" method="post">
        ...
        所属模块：
          ...
          &nbsp;
        页面字段类型： <select name="settingType" id="settingType" class="textfield">
	      <option value=""></option>
        ...
        &nbsp;
         ...
         <INPUT class="button" type="button" onclick="query(1);" value="检索" > 
          ...
          <TD noWrap align=right>
            <A href="javascript:query(1);">全部页面模型</A>
...
<TABLE cellSpacing=1 cellPadding=0 width="100%" border=0>
 ...
 <TR>
 <TD height=30>系统后台管理&nbsp;-&gt;&nbsp;
  ${not empty requestScope.module? requestScope.module.name : '全部'} 页面模型</TD>
 </TR></TBODY></TABLE>


<TABLE cellSpacing=1 cellPadding=3 width="100%" bgColor=#6298e1 border=0>
  <FORM name="formDel" action="${pageContext.request.contextPath}/pageModel/pageModelExpandManage.do" method="post">
  ...
  <TR>
    ...
    <STRONG><FONT color=#ffffff>页面标题名称</FONT></STRONG>
    </TD>
    <TD noWrap bgColor=#8db5e9>
    <FONT color=#ffffff><strong>关键字</strong></FONT></TD>
   
     <TD noWrap bgColor=#8db5e9>
    <FONT color=#ffffff><strong>面板主表</strong></FONT>
    </TD>
    <TD noWrap bgColor=#8db5e9>
    <FONT color=#ffffff><strong>页面字段类型</strong></FONT></TD>
    <TD noWrap bgColor=#8db5e9>
 ...
 <c:forEach  var="item" items="${requestScope.page.data}" varStatus="status">   
  ...
  <TR onmouseover="this.style.backgroundColor = '#FFFFFF'" style="CURSOR: hand" 
    ...
    <A onclick='changeAdminFlag("修改导航栏目")' 
      href="${pageContext.request.contextPath}/pageModel/pageModelExpandManage.do?methodCall=toPageModelEditForm&id=${item.id}">
      ${item.title }
    </A> 
    </TD>
  ...
  <TR>
    ...
    <INPUT class=button  onclick="loadNewTables();" type=button value=新增页面模型 >
    &nbsp;
    </TD>
