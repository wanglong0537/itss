...
function addQuery(){
  window.location.href="${pageContext.request.contextPath}/infoAdmin/sysTableQuery.do?methodCall=toForm&smtId=${param.smtId}&queryId=";
}
</script>
...
<TABLE cellSpacing=1 cellPadding=3 width="100%" bgColor=#6298e1 border=0>
  ...
  <TR>
    ...
    <TD noWrap bgColor=#8db5e9>
    <FONT color=#ffffff><STRONG>主表查询关键字</STRONG></FONT>
    </TD>
    <TD noWrap  bgColor=#8db5e9>
    <FONT color=#ffffff><STRONG>主表查询名称</STRONG></FONT>
    </TD>
    
    <TD noWrap bgColor=#8db5e9>
    <FONT color=#ffffff><STRONG>查询类型</STRONG></FONT>
    </TD>
    
    <TD width=90 bgColor=#8db5e9>
    <FONT color=#ffffff><STRONG>查看查询字段</STRONG></FONT>
    </TD>
 ...
 <c:forEach  var="item" items="${requestScope.sysTableQueries}" varStatus="status">   
  ...
  <TR onmouseover="this.style.backgroundColor = '#FFFFFF'" style="CURSOR: hand" 
    ...
    <A onclick='changeAdminFlag("修改导航栏目")' 
      href="${pageContext.request.contextPath}/infoAdmin/sysTableQuery.do?methodCall=listQueryColumn&queryId=${item.id}&smtId=${item.systemMainTable.id}">
    ...
    <TD width=90>
     ...
     <A onclick='changeAdminFlag("查看查询字段")' 
       href="${pageContext.request.contextPath}/infoAdmin/sysTableQuery.do?methodCall=listQueryColumn&queryId=${item.id}&smtId=${item.systemMainTable.id}">
      <FONT color="#330099">查看查询字段</FONT>
     </A>
    ...
    <TD width=48 align="center">
     <A onclick='changeAdminFlag("修改")' 
      href="${pageContext.request.contextPath}/infoAdmin/sysTableQuery.do?methodCall=toForm&smtId=${item.systemMainTable.id}&queryId=${item.id}">
  ...
  <TR>
    ...
    <INPUT class=button  onclick="addQuery();" type=button value="增加查询">&nbsp;
