...
<head>
  ...
  <%@include file="/includefiles.jsp"%>
    <META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=gbk">	
   	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/workflowRoleSearchForm.js"></script>  
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/workflowRoleListPanel.js"></script>
	...
	Ext.onReady(function(){	
	   ...
	   var workflowRoleListPanel = new WorkflowRoleListPanel();
	   
	   //bidApplyPanel.render("bidOrderApply");
	   
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[workflowRoleListPanel]
	   });
	});
...
<div id="bidOrderApply" style="height:100%"></div>
