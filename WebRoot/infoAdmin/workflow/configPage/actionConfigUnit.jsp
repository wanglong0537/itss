...
<head> 
  <title>欢迎使用IT服务系统</title> 
	...
	function updateTab(id,title, url) {
	   ...
	   var actionConfigUnit = new ActionConfigUnit({virtualDefinitionInfoId:'${param.virtualDefinitionInfoId}',nodeId:'${param.nodeId}'});
	   
	   actionConfigUnit.render("configUnitListPanel");
	   
	   new Ext.Viewport({
	     
	   	 layout:'fit',
	   	 items:[actionConfigUnit]
	   });
	});
