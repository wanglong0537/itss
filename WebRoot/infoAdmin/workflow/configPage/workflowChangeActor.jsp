...
<html>
	<head>
	 ...
	 <script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/workflowChangeActor.js"></script>
		<style type="text/css">
		.x-head {
	...
	Ext.onReady(function(){	
		...
		var changeActorPanel = new ChangeActorPanel();
		changeActorPanel.render("changeActorPanel");
	    new Ext.Viewport({
	   		layout : 'fit',
	   		items : [changeActorPanel]
	    });
	});
	...
	<body onload="changeSkin('${userInfo.userViewStyle}');">
		<div id="changeActorPanel" style="height: 100%"></div>
