...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/configUnitPanel.js"></script>
		<script type="text/javascript"
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/subProcessConfigUnit.js"></script>
		<style type="text/css">
.x-head {
...
.common-text {
	...
	function updateTab(id,title, url) {
	   ...
	   var subProcessConfigUnit = new SubProcessConfigUnit({desc:'${param.desc}',nodeId:'${param.nodeId}',virtualDefinitionInfoId:'${param.virtualDefinitionInfoId}'});
	   
	   subProcessConfigUnit.render("configUnitListPanel");
	   
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[subProcessConfigUnit]
	   });
	});
