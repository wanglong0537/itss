...
<head>
  <title>欢迎使用IT服务系统</title>
	...
	<META HTTP-EQUIV="Expires" CONTENT="0">
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/deployProcessPanel.js"></script>
	...
	Ext.onReady(function(){	
	   ...
	   var deployProcessPanel = new DeployProcessPanel();
