...
<head>
  <title>欢迎使用IT服务系统</title>
    ...
    <META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=gbk">
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/nodeViewPanel.js"></script>
	...
	Ext.onReady(function(){	
	   ...
	   var nodeViewPanel = new NodeViewPanel({processName:'${param.processName}',processId:'${param.processId}'});
	   
	  // bidApplyPanel.render("orderApply");
	    var panel = new Ext.TabPanel({
	   		//layout:'fit',
	   		enableTabScroll : true,
	   		deferredRender : false,//还没有实现延迟加载
	   		activeTab : 0,
	   		items:[nodeViewPanel]
	   });
	   new Ext.Viewport({
