...
<title>config</title>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/test/addBookForm.js"></script>
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/test/borrowBookForm.js"></script>
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/test/ConfigSourceDataPanel.js"></script>
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/test/ConfigSourceDataPanel2.js"></script>
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/test/ConfigItemComponent.js"></script>
