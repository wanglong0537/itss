...
<head> 
  <title>欢迎使用IT服务系统</title>   
    <%@include file="/includefiles.jsp"%>
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemRelationShip/configItemRelListReadOnly.js"></script>
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemRelationShip/configItemRelReadOnly.js"></script>
	<style type="text/css">  
		.x-head{ 
	...
	function updateTab(id,title, url) {
	   ...
	   var relListPanel= new RelListPanel();
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 frame:true,
	   	 items:[relListPanel]
...
<div id="configIpanel" style="height:100%"></div>
