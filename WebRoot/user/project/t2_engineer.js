 ...
 getFormflm_requireForm_panel: function() {
      var da = new DataAction();
		  var data = null;
			...
			if (this.dataId != '0') {
				data = da.getPanelElementsForEdit("flm_t2_engineer_project_plan", "flm_requireForm_panel", this.dataId);// 这是要随时变得
...
getGridflm_projectPlan_grid:function(){
  ...
  items : this.items,
	...
	initComponent : function() {
		...
		this.model="flm_t2_engineer_project_plan";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("flm_t2_engineer_project_plan",this);
		if(this.mybuttons!=""){
			this.buttons = {
			layout : 'table',
			height : 'auto',
