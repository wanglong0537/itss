  ...
  <title></title>
	...
	Ext.BLANK_IMAGE_URL = webContext+'/extEngine/resources/images/default/s.gif';	 
	 modLoader.OnStartupCompleted(function() {
	     var pagePanel = new PagePanel({dataId:'${param.dataId}'});		 
    ...
    Ext.onReady(function(){	
		  ...
		  modLoader.addModule('${pageContext.request.contextPath}/user/serviceCatalogueQuery/serviceCatalogueQueryView.js', 'Page');
