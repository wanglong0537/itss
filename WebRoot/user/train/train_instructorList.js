PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("panel_trainInstructor"); //da.getElementsForQuery("com.zsgj.itil.train.entity.TrainInstructor");
...
//				this.pageBar.formValue = this.formValue;
	...
	removeTrain : function(){
		var store = this.store;
				...
				var clazz = "com.zsgj.itil.train.entity.TrainInstructor";		
					if(!record){
