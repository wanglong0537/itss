...
<head>
  <title>欢迎使用IT服务系统</title>
	...
	<link rel='stylesheet' type='text/css' href="${pageContext.request.contextPath}/js/multisel/Multiselect.css"> 
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/noticeChange/noticeChangeForm.js"></script> 
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){	
	   ...
	   var pageTemplates = new PageTemplates({dataId:"${param.dataId}",flag:"${param.flag}"});
