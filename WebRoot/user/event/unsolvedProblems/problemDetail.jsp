...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/user/event/unsolvedProblems/problemDetail.js"></script>
		<style type="text/css">
.x-head {
...
.common-text {
	...
	function updateTab(id,title, url) {
	    ...
	    var  pagePanel = new PagePanel({pdataId:"${param.pdataId}", EventId:"${param.EventId}"});
