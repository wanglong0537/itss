...
<head> 
  <title>欢迎使用IT服务系统</title>   
    <%@include file="/includefiles.jsp"%> 	  
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/event/transactionFlow/engineerDealEvent/eventDeal.js"></script>
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/event/transactionFlow/engineerDealEvent/eventRelationPanel.js"></script>
	...
	function updateTab(id,title, url) {
	   ...
	   var eventDealPanel = new EventDealPanel({dataId:"${param.dataId}",taskId : '${param.taskId}'});
	   eventDealPanel.render("Customer");
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[eventDealPanel]
	   });
	});
