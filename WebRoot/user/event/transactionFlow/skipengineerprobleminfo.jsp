...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>                                                       
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/event/transactionFlow/skipengineerprobleminfo.js"></script> 
	<style type="text/css">  
		.x-head{ 
	...
	function updateTab(id,title, url) {
	   ...
	   var  pagePanel = new PagePanel({pdataId:"${param.pdataId}", EventId:"${param.EventId}", taskId : '${param.taskId}'});
	   pagePanel.render("configItemEnv");
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[pagePanel]
	   });
