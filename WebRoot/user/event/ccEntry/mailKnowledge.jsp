...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/event/ccEntry/mailKnowledge.js"></script> 	
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){	
	   ...
	   var pageTemplates = new PageTemplates({eventId:eventId,knowledgeId:knowledgeId});
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[pageTemplates]
	   });
