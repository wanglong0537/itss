	        ...
	        items:[
	            ...
	            autoLoad : {
					url : webContext + "/tabFrame.jsp?url=" + webContext
							+ "/user/knowledge/knowledgeSearch/knowledgeSearch.jsp",
					text : "页面正在加载中......",
					method : 'post',
					scope : this
					}
	            ...
	            autoLoad : {
					url : webContext + "/tabFrame.jsp?url=" + webContext
							+ "/user/knowledge/knowledgeSearch/knowFileSearch.jsp",
					text : "页面正在加载中......",
					method : 'post',
					scope : this
					}
	            ...
	            autoLoad : {
					url : webContext + "/tabFrame.jsp?url=" + webContext
							+ "/user/knowledge/knowledgeSearch/knowContractSearch.jsp",
					text : "页面正在加载中......",
					method : 'post',
					scope : this
					}
