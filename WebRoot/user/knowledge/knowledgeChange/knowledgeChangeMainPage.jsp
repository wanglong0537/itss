	        ...
	        items:[
	            ...
	            autoLoad : {
					url : webContext + "/tabFrame.jsp?url=" + webContext
							+ "/user/knowledge/knowledgeChange/knowledgeChange.jsp",
					text : "页面正在加载中......",
					method : 'post',
					scope : this
					}
	            ...
	            autoLoad : {
					url : webContext + "/tabFrame.jsp?url=" + webContext
							+ "/user/knowledge/knowledgeChange/knowFileChange.jsp",
					text : "页面正在加载中......",
					method : 'post',
					scope : this
					}
	            ...
	            autoLoad : {
					url : webContext + "/tabFrame.jsp?url=" + webContext
							+ "/user/knowledge/knowledgeChange/knowContractChange.jsp",
					text : "页面正在加载中......",
					method : 'post',
					scope : this
					}
