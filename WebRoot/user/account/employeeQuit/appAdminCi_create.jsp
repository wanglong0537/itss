...
<head>
  <title>欢迎使用IT服务系统</title> 
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/user/config/ButtonDataPanel.js"></script>
  
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/account/employeeQuit/appAdminCi_create.js"></script> 
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){	
	   ...
	   if("${param.dataId}"==""){
		alert('${param.accountDataId}');
	     var pageTemplates = new PageTemplates({dataId:"0",accountDataId:'${param.accountDataId}'});
	   }
	   else{
	   		var pageTemplates = new PageTemplates({dataId:'${param.dataId}',accountDataId:'${param.accountDataId}'});
	   }
