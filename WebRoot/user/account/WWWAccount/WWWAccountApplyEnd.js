PageTemplates = Ext.extend(Ext.Panel, {
	...
	getTabpanel : function(tab, tabTitle) {
		this.tabPanel = new Ext.TabPanel({
			...
			items : tab,
			tbar : [new Ext.Toolbar.TextItem('<font color=red>提示：</font><font color=blue>1.页面中带红色<font color=red>*</font>号的必填项，请在填写完整后再提交申请！2.如果两天不修改密码帐号将被锁定</font>')]
			...
			})]},
		{
		 ...
		 new Ext.form.Hidden({
		   ...
		   defaults : {
			...
			items:[ {
				html : '<font color=red size=3px><b>1、您的WWW帐号见下方，其初始密码为"123"。<br>&nbsp&nbsp重要：请在两个工作日内修改密码，否则帐号将被锁定！<br>2、您更改WWW密码的方法请访问：<a href="http://10.1.180.10:18888" target="_blank">http://10.1.180.10:18888</a><br>3、禁止共用、借用、盗用WWW帐号</b></font>',
				cls : 'common-text',
				style : 'color:red'
