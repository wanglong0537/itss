...
<head>
  <title>欢迎使用IT服务系统</title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/auditForms.js"></script>                                                 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/notice/noticeForm.js"></script>
	...
	Ext.onReady(function(){	
	   ...
	   if("${param.dataId}"==""){
	     var pageTemplates = new PageTemplates({dataId:"",configItemTypeId:citId});
	   }
	   else{
