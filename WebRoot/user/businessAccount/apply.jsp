...
<%@include file="/includefiles.jsp"%>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/businessAccount/apply.js"></script>
...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        //this.requireId = "${param.requireId}";
        //alert(this.requireId+"000000000000000000000");
    	Ext.onReady(function(){
    					
			var panel = new ApplyPanel({requireId:"${param.requireId}"});
			panel.render("panel");
			new Ext.Viewport({
	          layout:'fit',
	          items:[panel]
