ServiceCatalogueHistroyForm = Ext.extend(Ext.Panel, {
	...
	foredit : true,
	width : 780,
	clazz : "com.zsgj.itil.service.entity.ServiceCatalogueAuditHis",
	frame : true,
	...
	getProcessId:function(dataId){
		var clazz="com.zsgj.itil.service.entity.ServiceCatalogueAuditHis";
		var pid="";
	...
	initComponent : function() {
		...
		this.hisGrid = this.getGrid(this.dataId,
				"com.zsgj.itil.service.entity.ServiceCatalogueAuditHis",
				this.picPanel);
