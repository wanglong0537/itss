...
<head>
  <title></title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/protoculous-packer.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/Ext.ux.Notification.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/user/problemevent/mainListen.js"></script>
 ...
 //]]></script>
    ...
    Ext.onReady(function(){	
		  ...
		  modLoader.addModule('${pageContext.request.contextPath}/user/solution/solutionList.js', 'Page');
