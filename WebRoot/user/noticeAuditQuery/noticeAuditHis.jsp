...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/user/noticeAuditQuery/noticeAuditHis.js"></script>
<style type="text/css">
.x-head {
...
.common-text {
	...
	Ext.onReady(function(){	
	   ...
	   var applyForm = null;	   
	   	...
	   	histroyForm = new HistroyForm({dataId:'${param.dataId}',processId:'${param.processId}'});	
