...
<head>
  <title>欢迎使用IT服务系统</title> 
    <%@include file="/includefiles.jsp"%>
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/requireInfoForUser.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var operatePanel = new OperatePanel({
	   		pagePanel:'${param.pagePanel}',
	   		reqClass:'${param.reqClass}',
	   		dataId:'${param.dataId}',
