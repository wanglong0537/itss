PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequire4_m_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("sr2_m_makeInfoByEngineer",
	...
	//			if (this.dataId != '0') {
	//				data = da.getPanelElementsForEdit("sr2_m_makeInfoByEngineer", "panel_SRProjectPlan", this.dataId);// 这是要随时变得
	//				biddata = da.split(data);
	//			} else {
...
//		var ppId = sra.getRootProjectPlanId(this.dataId);
		...
		this.model = "sr2_m_makeInfoByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("sr2_m_makeInfoByEngineer",
				this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
