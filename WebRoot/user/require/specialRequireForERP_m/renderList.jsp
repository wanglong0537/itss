...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%> 
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP/renderList.js"></script> 
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){
	   ...
	   if("${param.dataId}"==""){
	     var pageTemplates = new PageTemplates({dataId:"0",configItemTypeId:citId,ccId:ccId,reqCls:reqCls,readOnly:"${param.readOnly}"});
	   }
	   else{
	   var pageTemplates = new PageTemplates({dataId:"${param.dataId}",configItemTypeId:citId,ccId:ccId,reqCls:reqCls,readOnly:"${param.readOnly}"});
	   }
