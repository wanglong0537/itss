PageTemplates = Ext.extend(Ext.Panel, {
	...
	saveAndSubmit : function() {
		...
		var formParam = Ext.getCmp('panel_srInfo_input2').form.getValues(false);
		var vp = null;
		if (formParam != null) {
	...
	getFormpanel_erpSR_it_m_input : function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("esr_m_engineerApplyTest",
...
//			loadMask : true,
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "esr_m_engineerApplyTest";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel(
				"esr_m_engineerApplyTest", this);
