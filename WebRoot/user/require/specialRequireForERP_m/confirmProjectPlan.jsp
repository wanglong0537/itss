...
<head>
  <title>欢迎使用IT服务系统</title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/requireAuditHis.js"></script>	                                                        
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/confirmProjectPlan.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var pageTemplates = new PageTemplates({dataId:"${param.dataId}",reqClass:"${param.reqClass}",readOnly:"${param.readOnly}"});
	   }
