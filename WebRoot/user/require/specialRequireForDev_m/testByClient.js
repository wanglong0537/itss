PageTemplates = Ext.extend(Ext.Panel, {
	...
	layoutConfig : {
		...
		var formParam = Ext.encode(getFormParam('panel_srInfo_input3'));
	...
	getFormpanel_SpecialRequireDevConfirm_m_Input : function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("devsr_m_testByClient",
	...
	getFormpanel_srInfo_input3 : function() {
		...
		for (var i = 0; i < data.length; i++) {
			...
			if(data[i].id!="itil_req_SpecialRequirementInfo$isCompleteCombo"
				&&data[i].id!="itil_req_SpecialRequirementInfo$isContentCombo"&&data[i].id !="itil_req_SpecialRequirementInfo$testFile"){
...
//			loadMask : true,
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "devsr_m_testByClient";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("devsr_m_testByClient",this);
