...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>  
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/normalRequire2_m/operateByEngineer2.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   if("${param.dataId}"==""){
	     var pageTemplates = new PageTemplates({dataId:"0",tabId:citId,taskId:'${param.taskId}',readOnly:"${param.readOnly}"});
	   }
	   else{
	   var pageTemplates = new PageTemplates({dataId:"${param.dataId}",tabId:citId,taskId:'${param.taskId}',readOnly:"${param.readOnly}"});
	   }
