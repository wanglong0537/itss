PageTemplates = Ext.extend(Ext.Panel, {
	...
	saveAndSubmit : function() {
		...
		Ext.Ajax.request({
			...
			params : {
				info : param,
				panel : 'panel_EBEngineerFeedback_Input',
				model : 'nr_m_EBEngineerFeedback'
			},
	...
	getFormpanel_ERP_NormalNeed1_m_Input : function() {
		...
		this.getFormButtons = buttonUtil.getButtonForPanel("panel_ERP_NormalNeed1_m_Input", this);
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("nr_m_EBEngineerFeedback",
	...
	initComponent : function() {
		...
		this.model = "nr_m_EBEngineerFeedback";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel(
				"nr_m_EBEngineerFeedback", this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
				height : 'auto',
