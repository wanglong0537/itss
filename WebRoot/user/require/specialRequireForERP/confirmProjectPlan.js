PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_erpSR_it_input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("esr_confirmProjectPlan",
	...
	initComponent : function() {
		...
		this.model = "esr_confirmProjectPlan";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("esr_confirmProjectPlan",this);
