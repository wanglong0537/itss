...
//		var buttom = com.faceye.ui.BottomLayout.init(copyRight);
	...
	buildTools : function(isAdmin, webContext) {
		...
		var suggestioBox = new Ext.Window({
		        ...
		        modal:true,
		        closeAction:'hide',
		        html:'<div class="itil-sugBox-content">感谢您使用我们提供的IT服务，并对我们的服务提出意见和建议！<br>您可以发送邮件到it-manage@digitalchina.com，或者拨打IT服务建议及投诉热线7888-0，我们有专人负责处理！</div><div class="itil-sugBox-unit">集团信息化管理部(神州数码IT)</div>'
	   		 });
		function toDCone() {
			window.open("http://dcone.digitalchina.com","_blank");
		}
		function toITService() {
			window.open("http://itss.digitalchina.com/ITcenter","_blank");
		}
