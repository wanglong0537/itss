...
public class LeaderRead extends BaseModel {
	...
	public Archives getArchives() {
		/* 63 */return this.archives;
	}

	public void setArchives(Archives in_archives) {
		/* 67 */this.archives = in_archives;
	}
	...
	public Long getArchivesId() {
		/* 161 */return getArchives() == null ? null : getArchives()
				.getArchivesId();
	}

	public void setArchivesId(Long aValue) {
		/* 168 */if (aValue == null) {
			/* 169 */this.archives = null;
			/* 170 */} else if (this.archives == null) {
			/* 171 */this.archives = new Archives(aValue);
			/* 172 */this.archives.setVersion(new Integer(0));
		} else {
			/* 174 */this.archives.setArchivesId(aValue);
		}
	}
	...
	public boolean equals(Object object) {
		/* 251 */if (!(object instanceof LeaderRead)) {
			/* 252 */return false;
		}
		/* 254 */LeaderRead rhs = (LeaderRead) object;
