...
public class NoticeAction extends BaseAction {
	...
	public String search() {
		...
		/* 128 */String searchContent = getRequest().getParameter(
				"searchContent");
		/* 129 */List<Notice> list = this.noticeService.findBySearch(
				searchContent, pb);
