...
/*     */   {
/*  55 */     ProcessInstance pi = this.jbpmService.getProcessInstanceByExeId(exeId);
/*  56 */     if (pi != null) {
...
/*  63 */     ProcessInstance pi = this.jbpmService.getProcessInstanceByTaskId(taskId);
/*  64 */     if (pi != null) {
...
/*     */ 
/*  86 */     processRun.setSubject(proDefinition.getName() + sdf.format(curDate) + "(" + curUser.getFullname() + ")");
...
/*     */ 
/* 122 */     Iterator fieldNames = runInfo.getParamFields().keySet().iterator();
/*     */ 
/* 124 */     while (fieldNames.hasNext()) {
/* 125 */       String fieldName = (String)fieldNames.next();
/* 126 */       ParamField paramField = (ParamField)runInfo.getParamFields().get(fieldName);
/* 127 */       FormData fd = null;
/* 128 */       if (!isNewsForm) {
/* 129 */         fd = this.formDataDao.getByFormIdFieldName(processForm.getFormId(), fieldName);
...
/*     */     {
/* 145 */       variables.put("flowStartUser", ContextUtil.getCurrentUser());
/*     */ 
/* 147 */       variables.put("processName", processRun.getProDefinition().getName());
/*     */ 
/* 149 */       String piId = this.jbpmService.startProcess(processRun.getProDefinition().getDeployId(), variables);
...
/* 167 */       pi = this.jbpmService.getProcessInstanceByTaskId(runInfo.getTaskId());
/*     */     else {
/* 169 */       pi = this.jbpmService.getProcessInstance(runInfo.getPiId());
/*     */     }
/*     */ 
/* 172 */     String xml = this.jbpmService.getDefinitionXmlByPiId(pi.getId());
/*     */ 
/* 174 */     String nodeType = this.jbpmService.getNodeType(xml, runInfo.getActivityName());
/*     */ 
/* 176 */     ProcessRun processRun = getByPiId(pi.getId());
/*     */ 
/* 179 */     Integer maxSn = Integer.valueOf(this.processFormDao.getActvityExeTimes(processRun.getRunId(), runInfo.getActivityName()).intValue());
...
/* 197 */       ParamField paramField = (ParamField)runInfo.getParamFields().get(key);
...
/*     */     {
/* 210 */       this.jbpmService.completeTask(runInfo.getTaskId(), runInfo.getTransitionName(), runInfo.getDestName(), runInfo.getVariables());
/*     */     }
/* 212 */     else this.jbpmService.signalProcess(pi.getId(), runInfo.getTransitionName(), variables);
/*     */   }
/*     */ 
/*     */   public void remove(Long runId)
/*     */   {
/* 220 */     ProcessRun processRun = (ProcessRun)this.dao.get(runId);
/* 221 */     if (ProcessRun.RUN_STATUS_INIT.equals(processRun.getRunStatus())) {
/* 222 */       List<ProcessForm> processForms = this.processFormDao.getByRunId(runId);
...
/*     */   {
/* 236 */     List processRunList = this.dao.getByDefId(defId, new PagingBean(0, 25));
 ...
 * Qualified Name:     com.xpsoft.oa.service.flow.impl.ProcessRunServiceImpl
