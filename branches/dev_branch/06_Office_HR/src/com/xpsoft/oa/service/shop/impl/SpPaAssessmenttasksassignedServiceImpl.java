...
import com.xpsoft.oa.dao.shop.SpPaAssessmenttasksassignedDao;
...
public class SpPaAssessmenttasksassignedServiceImpl extends BaseServiceImpl<SpPaAssessmenttasksassigned>
	implements SpPaAssessmenttasksassignedService{
	private SpPaAssessmenttasksassignedDao dao;
	
	public SpPaAssessmenttasksassignedServiceImpl(SpPaAssessmenttasksassignedDao dao){
		super(dao);
		this.dao = dao;
	}
	/*
	...
	public void multiSave(List<SpPaAssessmenttasksassigned> list, String templateId, Long deptId) {
		//删除相同模板ID的当月份的数据
		String sql = "delete from sp_pa_assessmenttasksassigned where " +
