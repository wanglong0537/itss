...
public class EmpProfileHist extends BaseModel {
	...
	//社会保险起缴日期、PBC签订日期、PBC执行日期、是否办理离职手续（复选框）
	protected Date providentDate;//社会保险起缴日期
	protected Date pbcSingedDate;//PBC签订日期
	...
	public Date getProvidentDate() {
		return providentDate;
	}

	public void setProvidentDate(Date providentDate) {
		this.providentDate = providentDate;
	}

	public Date getPbcSingedDate() {
		return pbcSingedDate;
	}

	public void setPbcSingedDate(Date pbcSingedDate) {
		this.pbcSingedDate = pbcSingedDate;
	}

	public Date getPbcExecuteDate() {
		return pbcExecuteDate;
	}

	public void setPbcExecuteDate(Date pbcExecuteDate) {
		this.pbcExecuteDate = pbcExecuteDate;
	}

	public Integer getIsDepartFiled() {
		return isDepartFiled;
	}

	public void setIsDepartFiled(Integer isDepartFiled) {
	...
	public boolean equals(Object object) {
		...
		.append(this.providentDate, rhs.providentDate)
		.append(this.pbcExecuteDate, rhs.pbcExecuteDate)
		.append(this.pbcSingedDate, rhs.pbcSingedDate)
		.append(this.isDepartFiled, rhs.isDepartFiled)
		/* 901 */.isEquals();
	}
	...
	public int hashCode() {
		...
		.append(this.providentDate)
		.append(this.pbcExecuteDate)
		.append(this.pbcSingedDate)
		.append(this.isDepartFiled)
		/* 955 */.toHashCode();
	}
	...
	public String toString() {
		...
		/* 899 */.append("providentDate", this.providentDate)
		/* 899 */.append("pbcExecuteDate", this.pbcExecuteDate)
