...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table style="width:700px;margin:0 auto;border:1px solid #000000" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td colspan="6" class="label" style="border-right:1px solid #000000;">工作目标完成情况</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="6" class="label" style="border-right:1px solid #000000;">工作业绩</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="6" class="label" style="border-right:1px solid #000000;">工作能力匹配</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="6" class="label" style="border-right:1px solid #000000;">晋升面谈</td>
			</tr>
			<tr>
