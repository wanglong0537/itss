...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form id="pbcForm" onsubmit="javascript:document.getElementById('saveSubmit').disabled='disabled';" action="${pageContext.request.contextPath}/shop/gridScoreSpPaAuthorizepbc.do" method="post">
			<input type="hidden" name="pbcId" value="${pbcId}"/>
