SpPaPerformanceindexscoreForm2 = Ext.extend(Ext.Window, {
	formPanel : null,
	constructor : function(a) {
		...
		Ext.apply(this, a);
		this.initComponents();
		SpPaPerformanceindexscoreForm2.superclass.constructor.call(this, {
			id : "SpPaPerformanceindexscoreForm2Win",
			layout : "fit",
	...
	initComponents : function() {
		this.formPanel = new Ext.FormPanel({
			...
			border : false,
			id : "SpPaPerformanceindexscoreForm2",
			defaultType : "textfield",
			items : [
				{
					name : "spPaPerformanceindexscore.id",
					id : "pisId",
					xtype : "hidden",
					value : this.pisId == null ? "0" : this.pisId
				}, {
					name : "spPaPerformanceindexscore.piId",
					id : "piIdForm2",
					xtype : "hidden",
					value : this.piId
				}, {
					name : "spPaPerformanceindexscore.pisType",
					id : "pisType",
					xtype : "hidden",
					value : this.pisType
				}, {
					...
					name : "spPaPerformanceindexscore.pisScore",
					id : "pisScore",
					anchor : "98%,98%",
					maskRe : /[\d.]/,
					allowBlank : false,
					...
					fieldLabel : "绩效系数",
					labelStyle : "text-align:right",
					name : "spPaPerformanceindexscore.coefficient",
					id : "coefficient",
					anchor : "98%,98%",
					maskRe : /[\d.]/,
					allowBlank : false,
							...
							items : [
								{
									...
									listeners : {
										focus : function(d) {
											...
											if(c.getCount() <= 0) {
												Ext.Ajax.request({
													url : __ctxPath + "/shop/loadSpPaAssessmentcriteria.do",
													method : "post",
													success : function(f) {
		...
		if(this.pisId != null && this.pisId != "undefined" && this.pisId != 0) {
			this.formPanel.getForm().load({
				...
				url : __ctxPath + "/shop/getSpPaPerformanceindexscore.do",
				params : {
					id : this.pisId,
					piId : this.piId
				},
			...
			var rowStore = Ext.getCmp("SpPaPerformanceindexscoreGrid").getStore().getAt(this.rowNumber);
	...
	save : function(a, b) {
		...
		if(a.getForm().isValid()) {
			var d = Ext.getCmp("SpPaPerformanceindexscoreGrid");
