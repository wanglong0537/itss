PublishSpPaKpipbcView = Ext.extend(Ext.Panel, {
	constructor : function(a) {
		...
		Ext.apply(this, a);
		this.initComponents();
		PublishSpPaKpipbcView.superclass.constructor.call(this, {
			id : "PublishSpPaKpipbcView",
			title : "已发布项目列表",
			region : "center",
			layout : "border",
			items : [
	...
	initComponents : function() {
		...
		this.store = new Ext.data.JsonStore({
			url : __ctxPath + "/shop/listSpPaKpipbc.do?Q_publishStatus_N_EQ=3",
	...
	delSpPaKpipbc : function() {
		var e = Ext.getCmp("PublishSpPaKpipbcGrid");
		...
		PublishSpPaKpipbcView.remove(f);
	},
	...
	previewSpPaKpipbc : function(a) {
		new SpPaKpipbcFormView({
			pbcId : a.data.id
		}).show();
	},
	onRowAction : function(c, a, d, e, b) {
		switch(d) {
			...
			case "btn-edit":
				...
				break ;
			case "btn-preview":
				this.previewSpPaKpipbc(a);
			default:
				break ;
		}
	}
});
PublishSpPaKpipbcView.remove = function(b) {
	var a = Ext.getCmp("PublishSpPaKpipbcGrid");
