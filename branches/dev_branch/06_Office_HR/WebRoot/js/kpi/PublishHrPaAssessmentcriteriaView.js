PublishHrPaAssessmentcriteriaView = Ext.extend(Ext.Panel, {
	constructor : function(a) {
		...
		Ext.apply(this, a);
		this.initComponents();
		PublishHrPaAssessmentcriteriaView.superclass.constructor.call(this, {
			id : "PublishHrPaAssessmentcriteriaView",
			title : "考核标准发布",
			region : "center",
			layout : "border",
			items : [
	...
	delHrPaAssessmentcriteria : function() {
		...
		PublishHrPaAssessmentcriteriaView.remove(f);
	},
...
PublishHrPaAssessmentcriteriaView.remove = function(b) {
	var a = Ext.getCmp("PublishHrPaAssessmentcriteriaGrid");
