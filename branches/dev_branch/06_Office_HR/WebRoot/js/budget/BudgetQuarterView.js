BudgetQuarterView = Ext.extend(Ext.Panel, {
	searchPanel : null,
	gridPanel : null,
	store : null,
	topbar : null,
	constructor : function(a) {
		...
		BudgetQuarterView.superclass.constructor.call(this, {
			id : "BudgetQuarterView",
			title : "季度预算草稿列表",
	...
	initUIComponents : function() {
		...
		this.store = new Ext.data.JsonStore({
			url : __ctxPath + "/budget/listBudget.do?Q_budgetType_N_EQ=2&Q_publishStatus_N_GE=0&Q_publishStatus_N_LT=3&Q_publishStatus_N_NEQ=1&alarm=true",
			root : "result",
		...
		var b = new Array();
		if (isGranted("_BudgetQuarterDel")) {
			b.push({
				iconCls : "btn-del",
				qtip : "删除",
		...
		if (isGranted("_BudgetQuarterView")) {
			b.push({
				iconCls : "btn-preview",
				qtip : "查看详情",
				style : "margin:0 3px 0 3px"
		...
		if (isGranted("_BudgetQuarterEdit")) {
			b.push({
				iconCls : "btn-edit",
				qtip : "编辑",
				style : "margin:0 3px 0 3px"
...
//		if (isGranted("_BudgetQuarterAdd")) {
//			this.topbar.add({
//				iconCls : "btn-add",
//				text : "添加年度预算",
//				xtype : "button",
