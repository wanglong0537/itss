...
App.importJs = {
	...
	PublishHrPaPerformanceindexView : [__ctxPath + "/js/kpi/PublishHrPaPerformanceindexView.js",
			...
			__ctxPath + "/js/kpi/HrPaPerformanceindexscoreForm1.js",
			__ctxPath + "/js/kpi/HrPaPerformanceindexscoreForm2.js",
			__ctxPath + "/js/kpi/CopyHrPaPerformanceindexForm.js"],
	...
	CriteriaTargetView : [__ctxPath + "/js/kpi/CriteriaTargetView.js",
			__ctxPath + "/js/kpi/TargetUploadResultForm.js"],
	CriteriaReachedView : [__ctxPath + "/js/kpi/CriteriaReachedView.js",
			__ctxPath + "/js/kpi/ReachUploadResultForm.js"],
	...
	ShowHistoryView : [__ctxPath + "/js/kpi/ShowHistoryView.js",
            __ctxPath + "/js/kpi/HisHrPaKpiPBC2UserForm.js",
			__ctxPath + "/ext3/ux/RowExpander.js"],
	ForAuditHrPaKpiPBC2UserView : [__ctxPath + "/js/kpi/ForAuditHrPaKpiPBC2UserView.js",
			__ctxPath + "/js/kpi/CheckHrPaKpiPBC2UserForm.js",
			__ctxPath + "/ext3/ux/RowExpander.js"],
	...
	HrPromotionHistView : [__ctxPath + "/js/hrm/HrPromotionHistView.js",
			__ctxPath + "/js/hrm/HrPromotionHistForm.js"],
	...
	DraftSpPaPerformanceindexView : [__ctxPath + "/js/shop/DraftSpPaPerformanceindexView.js",
			...
			__ctxPath + "/js/shop/SpPaPerformanceindexscoreView.js",
			__ctxPath + "/js/shop/SpPaPerformanceindexscoreForm1.js",
			__ctxPath + "/js/shop/SpPaPerformanceindexscoreForm2.js"],
	PublishSpPaPerformanceindexView : [__ctxPath + "/js/shop/PublishSpPaPerformanceindexView.js",
			__ctxPath + "/js/shop/SpPaPerformanceindexForm.js",
			__ctxPath + "/js/shop/SpPaPerformanceindexscoreView.js",
			__ctxPath + "/js/shop/SpPaPerformanceindexscoreForm1.js",
			__ctxPath + "/js/shop/SpPaPerformanceindexscoreForm2.js"],
	DraftSpPaKpipbcView : [__ctxPath + "/js/shop/DraftSpPaKpipbcView.js",
			__ctxPath + "/js/shop/SpPaKpipbcForm.js",
			__ctxPath + "/js/shop/SpPaPiView.js"],
	PublishSpPaKpipbcView : [__ctxPath + "/js/shop/PublishSpPaKpipbcView.js",
			__ctxPath + "/js/shop/SpPaKpipbcForm.js",
			__ctxPath + "/js/shop/SpPaPiView.js",
			__ctxPath + "/js/shop/SpPaKpipbcFormView.js"],
	SpPaKpiPBC2UserView : [__ctxPath + "/js/shop/SpPaKpiPBC2UserView.js",
			__ctxPath + "/js/shop/SpAuthorizePbcView.js",
			__ctxPath + "/js/shop/SpAuthorizePbcForm.js"],
	SpGradeAuthorizePbcView : [__ctxPath + "/js/shop/SpGradeAuthorizePbcView.js",
			__ctxPath + "/js/shop/SpGradeAuthorizePbcForm.js"],
	SpResultTotalScoreView : [__ctxPath + "/js/shop/SpResultTotalScoreView.js",
			__ctxPath + "/ext3/ux/RowExpander.js"],
	...
	HrPostApplyView	: [__ctxPath + "/js/hrm/HrPostApplyView.js",
			...
			__ctxPath + "/js/hrm/HrPostAssessmentForm.js"],
	...
	HrPositiveHistView : [__ctxPath + "/js/hrm/HrPositiveHistView.js",
			__ctxPath + "/js/hrm/HrPositiveHistForm.js"],
	BudgetQuarterView : [ __ctxPath + "/js/budget/BudgetQuarterView.js",
       			__ctxPath + "/js/budget/BudgetQuarterForm.js",
       			__ctxPath + "/js/budget/BudgetQuarterFormView.js",
       			__ctxPath + "/js/budget/BudgetQuarterItemWin.js" ],
	BudgetQuarterStatusView : [ __ctxPath + "/js/budget/BudgetQuarterStatusView.js",
	   			__ctxPath + "/js/budget/BudgetQuarterForm.js",
	   			__ctxPath + "/js/budget/BudgetQuarterFormView.js",
	   			__ctxPath + "/js/budget/BudgetQuarterItemWin.js" ],
