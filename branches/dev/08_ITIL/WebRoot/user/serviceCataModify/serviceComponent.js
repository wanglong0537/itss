				...
				Ext.Ajax.request({
					...
					params : {
						...
						bzparam : "{dataId :'"+ curId
							...
							+"',oldDataId:'"+oldModifyDataId+"',applyId : '"+curId+"',applyType: 'cproject',applyTypeName: '服务目录变更审批流程',customer:'',alterFlag:'变更','workflowHistory':'com.digitalchina.itil.service.entity.ServiceCatalogueAuditHis'}",						
