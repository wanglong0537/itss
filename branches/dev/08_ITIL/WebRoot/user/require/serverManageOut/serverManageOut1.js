				...
				if (idStr=='ServerManage$configItemCombo'){
					data[i]= new Ext.form.ComboBox({
						...
						store : new Ext.data.JsonStore({
							url : webContext
									+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.config.entity.ConfigItem&configItemType=77',
							fields : ['id', 'cisn'],
							listeners : {
...
//			collapsible : true,
			...
			items : [{
				...
				store : new Ext.data.JsonStore({
					url : webContext
							+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.config.entity.ConfigItemType',
					fields : ['id', 'name'],
					listeners : {
						beforeload : function(store, opt) {
				...
				store : new Ext.data.JsonStore({
					url : webContext
							+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.actor.entity.CustomerType',
					fields : ['id', 'name'],
					listeners : {
						beforeload : function(store, opt) {
				...
				store : new Ext.data.JsonStore({
					url : webContext
							+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.config.entity.ConfigItemStatus',
					fields : ['id', 'name'],
					listeners : {
						beforeload : function(store, opt) {
				...
				store : new Ext.data.JsonStore({
					url : webContext
							+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.config.entity.Environment',
					fields : ['id', 'name'],
					listeners : {
						beforeload : function(store, opt) {
...
//			collapsible : true,
			...
			items : [{
				...
				store : new Ext.data.JsonStore({
					url : webContext
							+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.config.extlist.entity.ServerType',
					fields : ['id', 'name'],
					listeners : {
						beforeload : function(store, opt) {
				...
				store : new Ext.data.JsonStore({
					url : webContext
							+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.config.extlist.entity.DiskRaidtype',
					fields : ['id', 'type'],
					listeners : {
						beforeload : function(store, opt) {
