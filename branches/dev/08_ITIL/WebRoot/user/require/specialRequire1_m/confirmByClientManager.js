PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequire3_m_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("nsr1_m_confirmByClientManager",
	...
	initComponent : function() {
		...
		this.model = "nsr1_m_confirmByClientManager";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("nsr1_m_confirmByClientManager",
				this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
