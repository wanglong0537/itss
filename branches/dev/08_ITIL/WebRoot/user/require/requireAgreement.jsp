...
<head>
  <title>欢迎使用IT服务系统</title> 
    <%@include file="/includefiles.jsp"%>  
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/requireAgreement.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var agreementPanel = new AgreementPanel({
	   		processId:'${process.id}',
	   		serviceItemId:'${process.serviceItem.id}',
	   		agreement:'${process.agreement}',
	   		processType:'${process.sidProcessType}'});
	   agreementPanel.render("configItemEnv");
	   new Ext.Viewport({
	   	 items:[agreementPanel]
	   });
	});
