PageTemplates = Ext.extend(Ext.Panel, {
	...
	saveAndSubmit : function() {
		var formParam = Ext.getCmp('panel_SpecialRequire3_Input').form.getValues(false);
		var vp = null;
		if (formParam != null) {
...
//	},
	...
	getFormpanel_SpecialRequire3_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("nsr1_comfirmByITManager",
...
//	},
	...
	initComponent : function() {
		...
		this.model = "nsr1_comfirmByITManager";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("nsr1_comfirmByITManager",
				this);
		this.mainButtons = this.mybuttons;
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
				height : 'auto',
