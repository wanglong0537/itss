...
//	title : '解决方案设计开发服务',
	...
	save : function() {
		...
		if(!Ext.getCmp('panel_SpecialRequire1_Input').form.isValid()){
		...
		var formParam = Ext.getCmp('panel_SpecialRequire1_Input').form.getValues(false);
		var vp = null;
		if (formParam != null) {
			vp = Ext.apply(formParam, vp, {});
		}
		var curUrl = webContext
				+ '/requireAction_saveApplyDraft.action?pagePanel=panel_SpecialRequire1_Input'
 ...
 getFormpanel_SpecialRequire1_Input: function() {
      var da = new DataAction();
		  var data = null;
			...
			var biddata = "";
			  ...
			  this.getFormButtons = buttonUtil.getButtonForPanel("panel_SpecialRequire1_Input",this);
			data = da.getRequireFormPanelElementsForEdit("panel_SpecialRequire1_Input",this.dataId);
		...
		this.formpanel_SpecialRequire1_Input= new Ext.form.FormPanel({
			id : 'panel_SpecialRequire1_Input',
			layout : 'table',
			height : 'auto',
			width : 800,
			frame : true,
			...
			title : "解决方案设计开发服务/业务部门解决方案支持服务",
			items : biddata,
			tbar : curbuttons
		});
		return this.formpanel_SpecialRequire1_Input;
	},
  items : this.items,
	/*
	...
	initComponent : function() {
	     ...
	     this.getFormpanel_SpecialRequire1_Input();
		this.items = [this.formpanel_SpecialRequire1_Input];
