...
<head>
  <title></title>
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/fastReqServiceList.js"></script>	  
	<style type="text/css">  
		.x-head{
    ...
    Ext.onReady(function(){	
		  ...
		  Ext.state.Manager.setProvider(new Ext.state.CookieProvider()); 
		   var pagePanel=new PagePanel({fastSiIds:"${param.fastSiIds}"});
