PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_erpSR_it_m_input: function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("esr_m_remark", "panel_erpSR_it_m_input", this.dataId);// 这是要随时变得
		} else {
	...
	getFormpanel_srInfo_input3 : function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("esr_m_remark",
...
//			loadMask : true,
  ...
  buttons : this.buttons,
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "esr_m_remark";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("esr_m_remark", this);
