...
<head>
  <title>欢迎使用IT服务系统</title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/requireAuditHis.js"></script>		                                                        
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/end.js"></script> 	                                                        
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/testByClient.js"></script>
	...
	Ext.onReady(function(){	
	   ...
	   var pageTemplates = new PageTemplates({dataId:"${param.dataId}",serviceItemId:"${param.serviceItemId}",readOnly:"${param.readOnly}"});
