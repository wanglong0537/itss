			...
			success : function(response, options) {
				...
				var submit=function(){
					Ext.Ajax.request({
							...
							params : {
								dataId : modifyId,
								bzparam : "{applyId:'"+ modifyId+"',dataId:'"+modifyId+"',applyName:'"+applyName+"',applyNum:'"+applyNum+"',modifyType : '"+type+"',applyType: 'mproject',applyTypeName: '配置项变更处理','workflowHistory':'com.digitalchina.itil.config.entity.CIBatchModifyAuditHis'}",						
