...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>                          
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemBatchModify/configItemInfoMaintenanceRel.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var pid="${param.pid}"
	   var createAllNecessaryRel="${param.createAllNecessaryRel}"
		var configItemInfo=new ConfigItemInfo({dataId:dataId,modifyId:modifyId,pid:pid,createAllNecessaryRel:createAllNecessaryRel});
	   new Ext.Viewport({
	   	 layout:'fit',
