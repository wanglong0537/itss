...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/user/event/transactionFlow/eventHistoryKnowledge.js"></script>
<style type="text/css">
.x-head {
...
.common-text {
	...
	Ext.onReady(function(){	
	   ...
	   var applyForm = null;	   
	   	...
	   	var histroyForm = new HistroyForm({knowledgeId:'${param.knowledgeId}'});	
