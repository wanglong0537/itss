PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchFor : function() {
		...
		var clazz = "com.digitalchina.itil.event.entity.Problem";
...
//								.getValues(false));
	...
	operate : function(problemReId, relationEventId, relatioProblemId,
		...
		var pr_eventCombo = new Ext.form.ComboBox({
			...
			store : new Ext.data.JsonStore({
				url : webContext
						+ '/extjs/comboDataAction?clazz=com.digitalchina.itil.event.entity.Event',
				fields : ['id', 'summary'],
				totalProperty : 'rowCount',
				root : 'data',
				id : 'id'
	...
	dealfile : function() {
		...
		var clazz = "com.digitalchina.itil.event.entity.ProblemHandleLog";
		var da = new DataAction();
