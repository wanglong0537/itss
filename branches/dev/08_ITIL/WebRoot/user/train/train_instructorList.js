PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("panel_trainInstructor"); //da.getElementsForQuery("com.digitalchina.itil.train.entity.TrainInstructor");
...
//				this.pageBar.formValue = this.formValue;
	...
	removeTrain : function(){
		var store = this.store;
				...
				var clazz = "com.digitalchina.itil.train.entity.TrainInstructor";		
					if(!record){
					...
					if (button == 'yes') {
						for(var i=0;i<records.length;i++){
							...
							var scId = records[i].get("TrainInstructor$id");
									Ext.Ajax.request({
	...
	initComponent : function(){
        ...
        this.mybuttons=buttonUtil.getButtonForModel("page_train_instructor_list",this);
		this.fp = this.getSearchForm();
		 this.modelTableName="TrainInstructor";
		var obj = da.getListPanelElementsForHead("panel_trainInstructor");
		...
		for (var i = 0; i < obj.length; i++) {
			...
			if(propertyName=='TrainInstructor$deleteFlag'){
				isHiddenColumn = true;
			}
		...
		this.store = da.getPanelJsonStore("panel_trainInstructor",obj); //add header 
