...
<head>
  <title>≈‰÷√œÓ…Û≈˙◊¥Ã¨≤È—Ø</title>
    <%@include file="/includefiles.jsp"%> 	
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/knowledgeAuditQuery/knowledgeAuditSearch.js"></script>
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){	
	   ...
	   var knowledgeAuditPagePanel = new KnowledgeAuditPagePanel();
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[knowledgeAuditPagePanel]
	   });
	});
