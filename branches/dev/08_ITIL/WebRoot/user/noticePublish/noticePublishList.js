...
//				this.pageBar.formValue = this.formValue;
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("page_notice"); //da.getElementsForQuery("com.digitalchina.itil.notice.entity.NewNotice");
	...
	initComponent : function(){
        ...
        this.mybuttons=buttonUtil.getButtonForModel("page_noticePublish_list",this);
		this.fp = this.getSearchForm();
		 this.modelTableName="NewNotice";
		var obj = da.getListPanelElementsForHead("page_notice");
		...
		this.store = da.getPanelJsonStore("page_notice",obj); //add header 
		...
		this.on("createSearch",this.createSearch,this);
