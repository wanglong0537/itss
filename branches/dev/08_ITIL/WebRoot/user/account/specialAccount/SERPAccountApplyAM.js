	...
	getFormpanel_SpecailAccountApply_Input : function() {
		...
		this.formpanel_SpecailAccountApply_Input = new Ext.form.FormPanel({
			...
			items:[
			{
				...
				style : '',
				width : 200,
				readOnly : false,//modify by liuying at 20100201 for 帐号管理员可以修改帐号名
				value : '',
				allowBlank : false,
				validator : '',
				vtype : ''
	      ...
	      buttons : [{
				...
				handler : function() {
				    ...
				    var accountName=Ext.getCmp('itil_ac_SpecialAccount$accountName').getValue();//add by liuying at 20100201 for 管理员可以修改帐号名
					Ext.Ajax.request({
						url : webContext+ '/accountAction_saveSpecaiAccountInfo.action',
						params : {
							rightDesc : rightDesc,
							dataId:dataId,
							accountName:accountName//add by liuying at 20100201 for 管理员可以修改帐号名
						},
