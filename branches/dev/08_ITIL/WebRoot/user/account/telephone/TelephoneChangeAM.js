		...
		this.formpanel_PersonAccountApply_Input = new Ext.form.FormPanel({
...

			{
...

				{
                    ...
                    animCollapse : false,
					collapsible : false,
					style : 'border:0px dotted #b0acac;margin:10px 0px 0px 15px',
					autoHeight : true,
					defaults : {
						bodyStyle : 'padding:4px'
					},
					...
					items : [
					{
						html : '<font color=red>*</font>现每月额度:',
						cls : 'common-text',
						style : 'width:135;text-align:right'
					}, new Ext.form.TextField({
						fieldLabel : '财年额度',
					...
					style : 'border:0px dotted #b0acac;margin:15px 0px 0px 15px',
					autoHeight : true,
					defaults : {
						bodyStyle : 'padding:4px'
					},
					...
					{
						html : '<font color=red>*</font>本月临时额度:',
						cls : 'common-text',
						style : 'width:135;text-align:right'
					}, new Ext.form.TextField({
						fieldLabel : '财年额度',
		   ...
		   buttons : [
				...
				handler : function() {
				   ...
				   var yearMoney=Ext.getCmp('itil_ac_PersonFormalAccount$userRight').getValue();
				   var beyondMoney=Ext.getCmp('itil_ac_PersonFormalAccount$beyondMoney').getValue();
					Ext.Ajax.request({
