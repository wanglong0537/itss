...
//			// title:'test',
//			id : "com.digitalchina.addRuleFile",
//			height : 160,
//			frame : true,
//			width : 1000,
...
//		});
		...
		var win = new Ext.Window({
			...
			buttons : [{
				...
				text : "保存",
				handler : function(){
					var processType=Ext.getCmp('com.digitalchina.writeInfo').getForm().findField('definitionType').getValue();
					var department=Ext.getCmp('com.digitalchina.writeInfo').getForm().findField('department').getValue();
					
				Ext.getCmp('com.digitalchina.writeInfo').getForm().submit({//客户端的数据提交给服务器
	...
	getSearchForm : function() {
		return new ApplySearchForm({
			...
			getMyItems : function() {
				...
				var  clazz = "com.digitalchina.info.framework.workflow.entity.DefinitionInfo";
