...
public class SRExpendPlan extends BaseObject {
   ...
   private java.lang.Double money;		//费用
   private com.digitalchina.itil.require.entity.SpecialRequirement specialRequire;	//关联需求
   private java.lang.String descn;		//内容
   private java.util.Date startDate;	//计划开始时间
   private java.util.Date endDate;		//计划结束时间
   private java.lang.Integer isFinish;	//是否已完成 1：已完成 0：未完成
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.digitalchina.itil.config.extlist.entity.SRExpendPlan other = (com.digitalchina.itil.config.extlist.entity.SRExpendPlan) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
