...
public class LanProject extends BaseObject {
   ...
   private com.digitalchina.itil.config.extlist.entity.LanProjectType type;
   ...
   public void setType(com.digitalchina.itil.config.extlist.entity.LanProjectType type){
	     this.type=type;
   }
   ...
   public com.digitalchina.itil.config.extlist.entity.LanProjectType getType(){
	     return this.type;
   }
