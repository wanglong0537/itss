...
public class HrInfoServiceLocator extends org.apache.axis.client.Service implements com.digitalchina.itil.account.webservice.HrInfoService {
    ...
    public com.digitalchina.itil.account.webservice.HrInfoServiceSoap_PortType getHrInfoServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.digitalchina.itil.account.webservice.HrInfoServiceSoap_PortType getHrInfoServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.digitalchina.itil.account.webservice.HrInfoServiceSoap_BindingStub _stub = new com.digitalchina.itil.account.webservice.HrInfoServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.digitalchina.itil.account.webservice.HrInfoServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.digitalchina.itil.account.webservice.HrInfoServiceSoap_BindingStub _stub = new com.digitalchina.itil.account.webservice.HrInfoServiceSoap_BindingStub(new java.net.URL(HrInfoServiceSoap_address), this);
                _stub.setPortName(getHrInfoServiceSoapWSDDServiceName());
                return _stub;
            }
        }
