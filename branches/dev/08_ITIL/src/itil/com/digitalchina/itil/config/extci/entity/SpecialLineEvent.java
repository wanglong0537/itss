...
public class SpecialLineEvent extends BaseObject {
   ...
   private com.digitalchina.itil.config.extci.entity.OfficeLocation startLocation;
   private com.digitalchina.itil.config.extci.entity.OfficeLocation endLocation;
   private java.lang.String lineServiceProviderA;
   private com.digitalchina.itil.config.extlist.entity.LineCostRecoverType lineCostRecoverType;
   ...
   private com.digitalchina.itil.config.extlist.entity.SpecialLineType type;
   ...
   public void setStartLocation(com.digitalchina.itil.config.extci.entity.OfficeLocation startLocation){
	     this.startLocation=startLocation;
   }
   public void setEndLocation(com.digitalchina.itil.config.extci.entity.OfficeLocation endLocation){
   ...
   public void setLineCostRecoverType(com.digitalchina.itil.config.extlist.entity.LineCostRecoverType lineCostRecoverType){
   ...
   public void setType(com.digitalchina.itil.config.extlist.entity.SpecialLineType type){
	     this.type=type;
   }
   ...
   public com.digitalchina.itil.config.extci.entity.OfficeLocation getStartLocation(){
	     return this.startLocation;
   }
   public com.digitalchina.itil.config.extci.entity.OfficeLocation getEndLocation(){
	     return this.endLocation;
   }
   public java.lang.String getLineServiceProviderA(){
	     return this.lineServiceProviderA;
   }
   public com.digitalchina.itil.config.extlist.entity.LineCostRecoverType getLineCostRecoverType(){
   ...
   public com.digitalchina.itil.config.extlist.entity.SpecialLineType getType(){
	     return this.type;
   }
