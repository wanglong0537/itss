...
public class Generator extends BaseObject {
   ...
   private com.digitalchina.itil.config.extlist.entity.GeneratorType type;
   ...
   public void setType(com.digitalchina.itil.config.extlist.entity.GeneratorType type){
	     this.type=type;
   }
   ...
   public com.digitalchina.itil.config.extlist.entity.GeneratorType getType(){
	     return this.type;
   }
