...
public class PBXEvent extends BaseObject {
	...
	private com.digitalchina.itil.config.extlist.entity.PBXTrunksType trunksType;
	...
	public com.digitalchina.itil.config.extlist.entity.PBXTrunksType getTrunksType() {
		return trunksType;
	}

	public void setTrunksType(com.digitalchina.itil.config.extlist.entity.PBXTrunksType trunksType) {
