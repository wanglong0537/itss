...
public class BIuniverseEvent extends BaseObject {
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.digitalchina.itil.config.extci.entity.BIuniverseEvent other = (com.digitalchina.itil.config.extci.entity.BIuniverseEvent) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
