...
/*  44 */   public static final Log logger = LogFactory.getLog(QueryFilter.class);
/*     */ 
...
/*     */ 
/* 113 */     if ((StringUtils.isNotEmpty(sort)) && (StringUtils.isNotEmpty(dir))) {
/* 114 */       addSorted(sort, dir);
/*     */     }
/*     */ 
/* 117 */     this.pagingBean = new PagingBean(start.intValue(), limit.intValue());
/*     */   }
/*     */ 
...
/* 143 */       if (value != null) {
/* 144 */         FieldCommandImpl fieldCommand = new FieldCommandImpl(fieldInfo[1], value, fieldInfo[3], this);
/* 145 */         this.commands.add(fieldCommand);
/*     */       }
/* 147 */     } else if ((fieldInfo != null) && (fieldInfo.length == 3)) {
/* 148 */       FieldCommandImpl fieldCommand = new FieldCommandImpl(fieldInfo[1], value, fieldInfo[2], this);
/* 149 */       this.commands.add(fieldCommand);
/*     */     } else {
/* 151 */       logger.error("Query param name [" + paramName + "] is not right format.");
/*     */     }
/*     */   }
/*     */ 
...
/* 165 */     this.commands.add(new SortCommandImpl(orderBy, ascDesc, this));
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.xpsoft.core.command.QueryFilter
