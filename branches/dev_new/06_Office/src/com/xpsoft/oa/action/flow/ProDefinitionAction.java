...
/*     */ 
/*  73 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
/*  74 */       .append(filter.getPagingBean().getTotalItems()).append(",result:");
/*     */ 
/*  76 */     JSONSerializer serializer = JsonUtil.getJSONSerializer(new String[] { "createtime" }).exclude(new String[] { "defXml" });
/*     */ 
...
/* 112 */       this.proDefinition = ((ProDefinition)this.proDefinitionService.get(this.defId));
/*     */     } else {
...
/* 117 */         ProType proType = (ProType)this.proTypeService.get(new Long(proTypeId));
/* 118 */         this.proDefinition.setProType(proType);
/*     */       }
/*     */ 
/*     */     }
/*     */ 
/* 123 */     JSONSerializer serializer = JsonUtil.getJSONSerializer(new String[] { "createtime" });
/*     */ 
...
/*     */     {
/* 138 */       Long uuid = Long.valueOf(Math.abs(UUID.randomUUID().getLeastSignificantBits()));
/*     */ 
/* 140 */       String defXml = JpdlConverter.JpdlGen(this.proDefinition.getDrawDefXml(), "pd" + uuid);
/*     */ 
/* 142 */       defXml = defXml.replace("<process", "<process xmlns=\"http://jbpm.org/4.0/jpdl\"");
/*     */ 
...
/* 163 */       ProType proType = (ProType)this.proTypeService.get(proTypeId);
/* 164 */       this.proDefinition.setProType(proType);
/*     */     }
/* 166 */     if (this.proDefinition.getDefId() != null) {
/* 167 */       ProDefinition proDef = (ProDefinition)this.proDefinitionService.get(this.proDefinition.getDefId());
/*     */       try {
/* 169 */         BeanUtil.copyNotNullProperties(proDef, this.proDefinition);
 ...
 * Qualified Name:     com.xpsoft.oa.action.flow.ProDefinitionAction
