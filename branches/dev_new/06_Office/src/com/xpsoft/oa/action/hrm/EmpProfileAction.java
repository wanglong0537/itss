...
/*     */ 
/*  75 */     JSONSerializer serializer = JsonUtil.getJSONSerializer(new String[] { "birthday", "startWorkDate", "checktime", "createtime" });
/*  76 */     buff.append(serializer.exclude(new String[] { "class", "job.class", "job.department" }).serialize(list));
/*  77 */     buff.append("}");
/*     */ 
...
/*  92 */         EmpProfile deletePro = (EmpProfile)this.empProfileService.get(new Long(id));
/*  93 */         deletePro.setDelFlag(Short.valueOf(EmpProfile.DELETE_FLAG_HAD));
...
/*     */   public String get()
/*     */   {
/* 108 */     EmpProfile empProfile = (EmpProfile)this.empProfileService.get(this.profileId);
/*     */ 
/* 110 */     JSONSerializer json = JsonUtil.getJSONSerializer(new String[] { "birthday", "startWorkDate", "createtime", "checktime" });
/*     */ 
/* 113 */     StringBuffer sb = new StringBuffer("{success:true,data:[");
/*     */ 
/* 115 */     sb.append(json.exclude(new String[] { "class", "department" }).serialize(empProfile));
/* 116 */     sb.append("]}");
...
/* 128 */       if (this.empProfileService.checkProfileNo(this.empProfile.getProfileNo())) {
/* 129 */         this.empProfile.setCreator(ContextUtil.getCurrentUser().getFullname());
/* 130 */         this.empProfile.setCreatetime(new Date());
/* 131 */         this.empProfile.setDelFlag(Short.valueOf(EmpProfile.DELETE_FLAG_NOT));
/* 132 */         pass = true;
/*     */       } else {
...
/*     */ 
/* 139 */     if (pass) {
/* 140 */       this.empProfile.setApprovalStatus(Short.valueOf(EmpProfile.CHECK_FLAG_NONE));
...
/*     */   {
/* 154 */     SimpleDateFormat date = new SimpleDateFormat("yyyyMMddHHmmss-SSSS");
...
/*     */   public String check()
/*     */   {
/* 165 */     EmpProfile checkProfile = (EmpProfile)this.empProfileService.get(this.profileId);
/* 166 */     checkProfile.setCheckName(ContextUtil.getCurrentUser().getFullname());
/* 167 */     checkProfile.setChecktime(new Date());
/* 168 */     checkProfile.setApprovalStatus(this.empProfile.getApprovalStatus());
/* 169 */     checkProfile.setOpprovalOpinion(this.empProfile.getOpprovalOpinion());
...
/* 181 */         EmpProfile deletePro = (EmpProfile)this.empProfileService.get(new Long(id));
/* 182 */         deletePro.setDelFlag(Short.valueOf(EmpProfile.DELETE_FLAG_NOT));
...
/* 194 */       this.empProfile = ((EmpProfile)this.empProfileService.get(this.profileId));
 ...
 * Qualified Name:     com.xpsoft.oa.action.hrm.EmpProfileAction
