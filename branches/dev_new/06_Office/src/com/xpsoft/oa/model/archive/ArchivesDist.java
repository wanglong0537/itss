...
public class ArchivesDist extends BaseModel {
	...
	/* 34 */public static final Short STATUS_UNSIGNED = Short
			.valueOf((short) 0);
	protected Long archDistId;
	protected String signNo;
	protected String subject;
	protected Short status; //0未阅读，1阅读
	...
	public ArchivesDist(Long in_archDistId) {
		/* 63 */setarchDistId(in_archDistId);
	}
	...
	public Long getarchDistId() {
		/* 97 */return this.archDistId;
	}

	public void setarchDistId(Long aValue) {
		/* 104 */this.archDistId = aValue;
	}
	...
	public boolean equals(Object object) {
		/* 294 */if (!(object instanceof ArchivesDist)) {
			/* 295 */return false;
		}
		/* 297 */ArchivesDist rhs = (ArchivesDist) object;
		/* 298 */return new EqualsBuilder()
		/* 299 */.append(this.archDistId, rhs.archDistId)
	...
	public String toString() {
		...
		/* 331 */.append("archDistId", this.archDistId)
