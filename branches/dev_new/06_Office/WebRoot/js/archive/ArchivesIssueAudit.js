											...
											},
											{
												...
												renderer : function(g, f, d, j,
													...
													if (isGranted("_ArchivesIssueEdit")) {
														h += '<button title="编辑" value=" " class="btn-edit" onclick="ArchivesIssueAudit.edit('
																+ i
																+ ')">&nbsp;&nbsp;</button>';
													}
													h += '<button title="查阅详情" value=" " class="btn-archives-detail" onclick="ArchivesIssueAudit.detail('
															+ i
															+ ')">&nbsp;&nbsp;</button>';
													return h;
												}
