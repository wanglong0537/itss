											...
											},
											{
												...
												renderer : function(g, f, d, j,
													...
													if (isGranted("_ArchivesIssueLeadEdit")) {
														h += '<button title="编辑" value=" " class="btn-edit" onclick="ArchivesIssueLead.edit('
																+ i
																+ ')">&nbsp;&nbsp;</button>';
													}
													h += '<button title="查阅详情" value=" " class="btn-archives-detail" onclick="ArchivesIssueLead.detail('
															+ i
															+ ')">&nbsp;&nbsp;</button>';
													return h;
												}
