												...
												renderer : function(g, f, d, j,
													...
													if (c == "0") {
														if (isGranted("_ArchivesDrafmDel")) {
															h += '<button title="删除" value=" " class="btn-del" onclick="ArchivesDraftManage.remove('
																	+ i
																	+ ')">&nbsp;&nbsp;</button>';
														}
														if (isGranted("_ArchivesDrafmEdit")) {
															h += '<button title="编辑草稿" value=" " class="btn-archive-draft" onclick="ArchivesDraftManage.editDraft('
																	+ i
																	+ ')">&nbsp;&nbsp;</button>';
														}
													} else {
														if (isGranted("_ArchivesDrafmEdit")) {
															h += '<button title="编辑" value=" " class="btn-edit" onclick="ArchivesDraftManage.edit('
																	+ i
																	+ ')">&nbsp;&nbsp;</button>';
														}
														h += '<button title="查看详情" value=" " class="btn-archives-detail" onclick="ArchivesDraftManage.detail('
																+ i
																+ ')">&nbsp;&nbsp;</button>';
													}
													return h;
