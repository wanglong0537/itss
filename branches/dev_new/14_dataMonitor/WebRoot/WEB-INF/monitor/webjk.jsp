...
<form action="${pageContext.request.contextPath}/monitor_toGetAllWebMonitor.action" method="post">
<table>
<tr style="font:12px">
<td>开始时间</td>
...
<table width="100%">
<tr>
<td colspan="4"><div align="center"><font size="3"><strong>web应用连通性监控</strong></font></div>
</td>
</tr>
</table>
