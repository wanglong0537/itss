...
public class GatewayEvent extends BaseObject {
   ...
   private com.zsgj.itil.config.extlist.entity.GatewayType type;
   ...
   public void setType(com.zsgj.itil.config.extlist.entity.GatewayType type){
	     this.type=type;
   }
   ...
   public com.zsgj.itil.config.extlist.entity.GatewayType getType(){
	     return this.type;
   }
