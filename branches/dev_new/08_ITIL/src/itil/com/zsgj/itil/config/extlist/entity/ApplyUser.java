...
public class ApplyUser extends BaseObject {
   ...
   private com.zsgj.info.framework.security.entity.UserInfo accountApplyUser;
   ...
   public void setAccountApplyUser(com.zsgj.info.framework.security.entity.UserInfo accountApplyUser){
   ...
   public com.zsgj.info.framework.security.entity.UserInfo getAccountApplyUser(){
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.zsgj.itil.config.extlist.entity.ApplyUser other = (com.zsgj.itil.config.extlist.entity.ApplyUser) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
