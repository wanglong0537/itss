...
public class ERP_NormalNeed extends BaseObject {
   ...
   public void setOldApply(com.zsgj.itil.require.entity.ERP_NormalNeed oldApply){
   ...
   public void setApplyDept(com.zsgj.info.framework.security.entity.Department applyDept){
	     this.applyDept=applyDept;
   }
   public void setCostConter(java.lang.String costConter){
	     this.costConter=costConter;
   }
   public void setApplyUser(com.zsgj.info.framework.security.entity.UserInfo applyUser){
	     this.applyUser=applyUser;
   }
   public void setTel(java.lang.String tel){
	     this.tel=tel;
   }
   public void setRequireLevel(com.zsgj.itil.config.extlist.entity.RequirementLevel requireLevel){
