...
<html>
	<head>
		...
		<script type="text/javascript"
			...
			<script type="text/javascript"
			src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/addMarkFormToNextNode.js"></script>
		<script type="text/javascript"
...
.common-text {
	...
	function updateTab(id,title, url) {
	   ...
	   var addMarkFormToNextNode = new AddMarkFormToNextNode({taskId : '${param.taskId}'});
	   
	   addMarkFormToNextNode.render("configUnitListPanel");
	   
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[addMarkFormToNextNode]
	   });
	});
