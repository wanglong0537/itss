...
<form action="${pageContext.request.contextPath}/workflow/execute.do">
	<input type="hidden" name="done" value="y">
	<input type="hidden" name="methodCall" value="audit">
		...
		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">		
			...
			<tr>
				...
				<td width="50%" bgcolor="E6EAEC" align="center">
					重新提交<input name="result" type="radio" value="Y/RESUBMIT" checked>&nbsp;&nbsp;
					终止流程<input name="result" type="radio" value="N/END">
				</td>			
			</tr>		
		</table>
