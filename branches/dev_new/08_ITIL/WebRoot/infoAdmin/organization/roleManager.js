		...
		this.deptMenu=new Ext.form.ComboBox({
			...
			store : new Ext.data.JsonStore({
				url : webContext + '/menu_findDeptMenuByDept.action',
						//+ '/extjs/comboDataAction?clazz=com.zsgj.info.appframework.menu.entity.DeptMenu',
				fields : ['id', 'name'],
				//totalProperty : 'rowCount',
				root : 'data'
			}),
...
//			store : new Ext.data.JsonStore({
//				url : webContext
//						+ '/extjs/comboDataAction?clazz=com.zsgj.info.appframework.template.entity.DeptMenuTemplate',
