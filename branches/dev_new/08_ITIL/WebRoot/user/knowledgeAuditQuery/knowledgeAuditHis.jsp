...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/user/knowledgeAuditQuery/knowledgeAuditHis.js"></script>
<style type="text/css">
.x-head {
...
.common-text {
	...
	Ext.onReady(function(){	
	   ...
	   var applyForm = null;	   
	   	var knowledgeHistroyForm = new KnowledgeHistroyForm({dataId:'${param.dataId}'});	
	  // orderInfoForm.render("orderApplyInfo");
	   var panel = new Ext.Panel({
	   		autoScroll: true,
	   		items:[knowledgeHistroyForm]
	   });
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 autoScroll:true,
