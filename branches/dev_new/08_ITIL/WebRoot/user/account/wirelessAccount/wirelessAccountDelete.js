PageTemplates = Ext.extend(Ext.Panel, {
	...
	getTabpanel : function(tab, tabTitle) {
		this.tabPanel = new Ext.TabPanel({
			...
			items : tab,
			tbar : [new Ext.Toolbar.TextItem('<font color=red>提示：</font><font color=blue>1.页面中带红色<font color=red>*</font>号的必填项，请在填写完整后再提交申请！<font color=red>*2.如果有WWW账号提交删除，MSN账号也将被删除!</font></font>')]
			...
			items:[{
				...
				listeners : {
					...
					'select' : function(combo, record, index) {
						  ...
						  if (!r.success) {
                                   Ext.MessageBox.alert("提示","申请人不存在可删除的无线网络帐号！");
								var userInfo = Ext
