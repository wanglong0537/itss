...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>  
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/account/commonAccount/commonAccountRightChange.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var citId="";
	   var serviceName='${serviceItemName}';
	    if("${param.dataId}"==""){
