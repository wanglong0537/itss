 ...
 getFormpanel_SpecialRequireDevConfirm_m_Input: function() {
      var da = new DataAction();
		  var data = null;
			...
			if (this.dataId != '0') {
				data = da.getPanelElementsForEdit("devsr_confirmByServiceManager_m", "panel_SpecialRequireDevConfirm_m_Input", this.dataId);// 这是要随时变得
			} else {
  ...
  buttons : this.buttons,
	...
	initComponent : function() {
		...
		this.model = "devsr_confirmByServiceManager_m";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel(
				"devsr_confirmByServiceManager_m", this);
