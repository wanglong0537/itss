PageTemplates = Ext.extend(Ext.Panel, {
	...
	saveAndSubmit : function() {
		...
		Ext.Ajax.request({
			...
			success : function(response, options) {
				var costCenterManager = Ext.getCmp('SRprojectContracts$costCenterManagerCombo').getValue();//成本中心负责人
				Ext.Ajax.request({
					url :  webContext
	...
	getFormpanel_SpecialRequireDevConfirm_m_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("devsr_m_confirmShareByUser",
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "devsr_m_confirmShareByUser";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("devsr_m_confirmShareByUser", this);
