...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequire2_m/testByClient.js"></script> 	
	...
	Ext.onReady(function(){	
	   ...
	   var citId="";
	   if("${param.dataId}"==""){
	     var pageTemplates = new PageTemplates({dataId:"0",readOnly:"${param.readOnly}"});
	     Ext.getCmp('panel_SRTestReport').store.reload();
	   }
	   else{
	  var pageTemplates = new PageTemplates({dataId:"${param.dataId}",reqClass:"${param.reqClass}", taskId : "${taskId}",readOnly:"${param.readOnly}"});
	    Ext.getCmp('panel_SRTestReport').store.reload();
	   }
