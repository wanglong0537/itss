PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_tempRequire : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("temp_testByClient","panel_tempRequire", this.dataId);// 这是要随时变得
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("temp_testByClient",
...
//			loadMask : true,
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "temp_testByClient";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("temp_testByClient",this);
