PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequireDevConfirm_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("devsr_confirmByClient",
	...
	initComponent : function() {
		...
		this.model = "devsr_confirmByClient";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("devsr_confirmByClient",
				this);
