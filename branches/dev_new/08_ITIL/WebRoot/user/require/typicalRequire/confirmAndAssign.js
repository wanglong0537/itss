...
PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_typicalRequire_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("tr_requireAuditAndAssign","panel_typicalRequire_Input", this.dataId);// 这是要随时变得
...
//				}]
	...
	initComponent : function() {
		...
		this.model = "tr_requireAuditAndAssign";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("tr_requireAuditAndAssign", this);
