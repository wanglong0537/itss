...
<html>
    ...
    <%@include file="/includefiles.jsp"%>
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/user/event/eventReport/eventDetail.js"></script>
<style type="text/css">
.x-head {
...
.common-text {
	...
	Ext.onReady(function(){	
	   ...
	   var histroyForm = new HistroyForm({dataId:'${param.dataId}',knowledgeId:'${param.knowledgeId}'});	
