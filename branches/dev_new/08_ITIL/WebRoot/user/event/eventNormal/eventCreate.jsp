...
<head>
  <title>欢迎使用IT服务系统</title> 
    <%@include file="/includefiles.jsp"%> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/event/eventNormal/eventCreate.js"></script>
	...
	Ext.onReady(function(){	
	   ...
	   var eventPanel = new PagePanel({isSupportEngineer:'${isSupportEngineer}'});
