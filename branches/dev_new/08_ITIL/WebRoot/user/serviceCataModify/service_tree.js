								...
								success : function(response) {
									...
									if(type=="item"){
										...
										var win1 = new Ext.Window({
												...
												draggable:true,
												autoLoad:{
													url:webContext+"/tabFrame.jsp?url="+webContext+"/user/serviceCataModify/configItemServiceView.jsp?dataId="+id,
													text:"页面加载中......",
													method:'post',
													scripts:true,
													scope:this
...
//					                		emptyText : '请填写价格'
					                	...
					                	if(dispFlag=="null"||dispFlag==null){
					                		...
					                		Ext.getCmp("dispFlagCombo").setValue(disp);
					                	}else{
					                		Ext.getCmp("dispFlagCombo").setValue(dispFlag);
					                	}
					                	if(!win){
						                	win = new Ext.Window({
												id : 'editWin',
