...
public class SystemLogAction extends BaseAction {
	...
	public String list() {
		...
		/* 53 */List<SystemLog> list = this.systemLogService.getAll(filter);

		/* 55 */Type type = new TypeToken<List<SystemLog>>() {
		}
		/* 55 */.getType();
	...
	public String get() {
		/* 90 */SystemLog systemLog = (SystemLog) this.systemLogService
				.get(this.logId);
