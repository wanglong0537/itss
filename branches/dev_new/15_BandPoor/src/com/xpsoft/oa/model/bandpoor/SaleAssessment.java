...
public class SaleAssessment extends BaseModel{
	...
	public BeElectedBandPoor getBeElectedBPId() {
		return beElectedBPId;
	}
	public void setBeElectedBPId(BeElectedBandPoor beElectedBPId) {
		this.beElectedBPId = beElectedBPId;
	}
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((beElectedBPId == null) ? 0 : beElectedBPId.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final SaleAssessment other = (SaleAssessment) obj;
		if (beElectedBPId == null) {
			if (other.beElectedBPId != null)
				return false;
		} else if (!beElectedBPId.equals(other.beElectedBPId))
			return false;
		if (createDate == null) {
