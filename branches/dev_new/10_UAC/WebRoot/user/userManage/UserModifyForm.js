UserModifyForm = Ext.extend(Ext.Window, {
	formPanel : null,
	groupPanel : null,
	constructor : function(a) {
		...
		Ext.apply(this, a);
		this.initComponents();
		UserModifyForm.superclass.constructor.call(this, {
			id : "UserModifyFormWin",
			layout : "border",
			items : [
			...
			columns : [
				new Ext.grid.RowNumberer(),
				{
					...
					renderer : function(r, q, o, u, p) {
						var t = o.data.dn;
						var s = "";
						//s += '<a href="#" title="删除" onclick="UserModifyForm.del()">删除</a>';
						return s;
					}
				}
			],
							...
							items : [
								{
									...
									handler : function() {
										...
										var uid = Ext.getCmp("UserModifyForm").form.getValues().uid;
										...
										if(img == "") {
											...
											Ext.getCmp("UserModifyForm").form.submit({
												method : "post",
