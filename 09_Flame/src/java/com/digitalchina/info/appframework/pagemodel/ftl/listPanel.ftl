<#macro creatListPanel  modelTableName clazz panelName modelName>
PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("${panelName}"); //da.getElementsForQuery("${clazz}");
	...
	initComponent : function(){
        ...
        this.mybuttons=buttonUtil.getButtonForModel("${modelName}",this);
		...
		this.store = da.getPanelJsonStore("${panelName}",obj); //add header 
