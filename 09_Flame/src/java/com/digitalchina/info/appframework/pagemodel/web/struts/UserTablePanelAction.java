...
import com.digitalchina.info.appframework.pagemodel.servlet.CoderForButton;
...
public class UserTablePanelAction extends BaseDispatchAction{
	...
	private UserPanelService ups =  (UserPanelService) getBean("userPanelService");
	...
	public ActionForward list(ActionMapping mapping,
		...
		Page page = ups.findPagePanel(params, pageNo, pageSize);
...
//		Module module=pagePanel.getModule();
		...
		List xtypes=super.getService().findAll(PagePanelType.class);
	...
	public ActionForward remove(ActionMapping mapping,
		...
		int pageNo = HttpUtil.getInt(request, "pageNo", 1);
		this.ups.removePagePanel(pagePanelIds);
		
		return HttpUtil.redirect("userMainTablePanel.do?methodCall=list&pageNo="+pageNo); //+pageNo+"&level="+level
	}
...
//		searchFactor = new String(searchFactor.getBytes("gbk"),"utf-8");
		...
		Page page = pps.findPagePanelByPage(searchFactor, null, pageNo, pageSize);
...
//				if(foreignTableColumn==null||!Pattern.matches("^\\+?[0-9][0-9]*$", foreignTableColumn)){
//					return null;
//				}
				SystemMainTableColumn systemMainTableColumn = new SystemMainTableColumn();
				...
				//SystemMainTable systemMainTable = pps.findSystemMainTableByName(tableName);
			//	String json = "";
