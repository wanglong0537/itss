/**
 * @Probject Name: SSOTest
 * @Path: com.itssSingleSignOutFilter.java
 * @Create By Jack
 * @Create In 2011-6-4 下午05:37:52
 * TODO
 */
...
/**
 * @Class Name SingleSignOutFilter
 * @Author Jack
 * @Create In 2011-6-4
 */
public class SingleSignOutFilter extends AbstractConfigurationFilter {
	...
	public void doFilter(ServletRequest servletRequest,
		...
		System.out.println(request.getRequestURL().toString() + a);
