package com.zsgj.info.framework.util.idgen;
...
//		}
	...
	public static RuleBase readRule(List<String> rulePaths){		
		...
		for(int i=0;i<rulePaths.size();i++) {		
			...
			Reader source = new InputStreamReader(IdGenRuleHelper.class.getResourceAsStream(drl));		
