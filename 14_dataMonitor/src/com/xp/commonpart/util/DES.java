 ...
 */
public class DES {
	 private static String strDefaultKey = "metarnet";  
	  ...
	  /** 
	   * 将表�?16进制值的字符串转换为byte数组�? �? public static String byteArr2HexStr(byte[] arrB) 
	   * 互为可�?�的转换过程 
	   *  
	   * @param strIn 
	   *            �?要转换的字符�? 
	  ...
	  /** 
	   * 从指定字符串生成密钥，密钥所�?的字节数组长度为8�? 不足 8位时后面�?0，超�?8位只取前8�? 
	   *  
	   * @param arrBTmp 
	   *            构成该字符串的字节数�? 
	   * @return 生成的密�? 
