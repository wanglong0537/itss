...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/treegrid/css/TreeGridLevels.css"/>
		 -->
		<script type="text/javascript" src="${pageContext.request.contextPath}/ext-3.2.1/adapter/ext/ext-base-debug-w-comments.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/ext-3.2.1/ext-all-debug-w-comments.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/ext-3.2.1/ux/ProgressBarPager.js"></script>
