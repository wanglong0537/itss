...
/* 19 */     if (StringUtils.isEmpty(paramValue)) return null;
...
/* 35 */         value = DateUtils.parseDate(paramValue, new String[] { "yyyy-MM-dd", "yyyy-MM-dd HH:mm:ss" });
/* 36 */       } else if ("DL".equals(type)) {
/* 37 */         Calendar cal = Calendar.getInstance();
/* 38 */         cal.setTime(DateUtils.parseDate(paramValue, new String[] { "yyyy-MM-dd" }));
/* 39 */         value = DateUtil.setStartDay(cal).getTime();
/* 40 */       } else if ("DG".equals(type)) {
/* 41 */         Calendar cal = Calendar.getInstance();
/* 42 */         cal.setTime(DateUtils.parseDate(paramValue, new String[] { "yyyy-MM-dd" }));
/* 43 */         value = DateUtil.setEndDay(cal).getTime();
/*    */       } else {
/* 45 */         value = paramValue;
/*    */       }
/*    */     } catch (Exception ex) {
/* 48 */       logger.error("the data value is not right for the query filed type:" + ex.getMessage());
/*    */     }
/* 50 */     return value;
/*    */   }
/*    */ }
 ...
 * Qualified Name:     com.xpsoft.core.util.ParamUtil
