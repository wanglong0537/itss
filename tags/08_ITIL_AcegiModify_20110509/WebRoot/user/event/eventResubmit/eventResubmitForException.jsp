...
<head>
  <title>欢迎使用IT服务系统</title> 
    <%@include file="/includefiles.jsp"%> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/event/eventResubmit/eventResubmitForException.js"></script>
	...
	Ext.onReady(function(){	
	   ...
	   var eventPanel = new PagePanel({dataId:'${param.dataId}'});
	    eventPanel.render("configItemEnv");
	    new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[eventPanel]
	   });
