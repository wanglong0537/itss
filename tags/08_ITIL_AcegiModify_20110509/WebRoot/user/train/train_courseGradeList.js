PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("panel_trainCourseGrade"); //da.getElementsForQuery("com.zsgj.itil.train.entity.TrainCourseGrade");
...
//				this.pageBar.formValue = this.formValue;
	...
	removeTrain : function(){
		var store = this.store;
				...
				var clazz = "com.zsgj.itil.train.entity.TrainCourseGrade";		
					if(!record){
