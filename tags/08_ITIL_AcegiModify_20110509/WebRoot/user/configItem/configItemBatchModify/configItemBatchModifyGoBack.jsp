...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>                          
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemBatchModify/configItemBatchModifyGoBack.js"></script> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemBatchModify/configItemRelList.js"></script> 
	...
	window.parent.auditContentWin.setTitle("配置变更窗口");
	...
	Ext.onReady(function(){	
	   ...
	   var pageTemplates = new PageTemplates({dataId:dataId,typeId:typeId,type:type});
