...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>                          
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemBatchModify/configItemRelModify.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var oldRid="${param.oldRid}"
	   var relationshipModifyPanel=new RelationshipModifyPanel({rid:rid,pid:pid,modifyId:modifyId,oldRid:oldRid});
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[relationshipModifyPanel]
	   });
	});
