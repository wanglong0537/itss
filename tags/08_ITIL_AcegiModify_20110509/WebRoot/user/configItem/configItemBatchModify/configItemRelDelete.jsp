...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>                          
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemBatchModify/configItemRelDelete.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var relationshipDeletePanel=new RelationshipDeletePanel({rid:rid,pid:pid,modifyId:modifyId,oldRid:oldRid});
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[relationshipDeletePanel]
	   });
	});
