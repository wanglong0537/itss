  ...
  <title>欢迎使用IT服务系统</title>
   <%@include file="/includefiles.jsp"%>
	...
	<link rel='stylesheet' type='text/css' href="${pageContext.request.contextPath}/js/multisel/Multiselect.css">                                               
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/notice/noticeInfoForUser.js"></script> 
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){	
	   ...
	   if("${dataId}"==""){
	     var pageTemplates = new PageTemplates({dataId:""});
	   }
	   else{
	   var pageTemplates = new PageTemplates({dataId:"${dataId}"});
	   }
