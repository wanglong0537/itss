 ...
 getFormpanel_SpecialRequireDevConfirm_Input: function() {
      var da = new DataAction();
		  var data = null;
			...
			if (this.dataId != '0') {
				data = da.getPanelElementsForEdit("devsr_confirmByServiceManager", "panel_SpecialRequireDevConfirm_Input", this.dataId);// 这是要随时变得
			} else {
  ...
  buttons : this.buttons,
	...
	initComponent : function() {
		...
		this.model = "devsr_confirmByServiceManager";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel(
				"devsr_confirmByServiceManager", this);
