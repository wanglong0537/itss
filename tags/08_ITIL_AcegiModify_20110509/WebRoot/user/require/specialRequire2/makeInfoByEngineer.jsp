...
<head>
  <title>欢迎使用IT服务系统</title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/SRAction.js"></script> 		                      
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequire2/projectPlanList.js"></script>		                                                        
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequire2/makeInfoByEngineer.js"></script> 
