  ...
  <title></title>
	...
	Ext.BLANK_IMAGE_URL = webContext+'/extEngine/resources/images/default/s.gif';	 
	 modLoader.OnStartupCompleted(function() {
	     var pagePanel = new PagePanel({rootId:'${serviceItemId}',rootName:'${serviceItemName}',tableName:'${tableName}',processTypeSum:'${processTypeSum}',gridName:'${gridName}'});		 
    ...
    Ext.onReady(function(){	
		  ...
		  modLoader.addModule('${pageContext.request.contextPath}/user/require/siChildList.js', 'Page');
