PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_ERP_NormalNeed3_m_Input : function() {
		var da = new DataAction();
		var data = null;
		// 判断是新增还是修改
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("nr_m_EBEngineerFeedback2",
					"panel_ERP_NormalNeed3_m_Input", this.dataId);// 这是要随时变得
		} else {
			data = da.getPanelElementsForAdd("panel_ERP_NormalNeed3_m_Input");
		}
		biddata = da.splitForReadOnly(data);
		this.formpanel_ERP_NormalNeed3_m_Input = new Ext.form.FormPanel({
		...
		return this.formpanel_ERP_NormalNeed3_m_Input;
	},
	...
	initComponent : function() {
		...
		this.model = "nr_m_EBEngineerFeedback2";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("nr_m_end2", this);
		...
		this.getFormpanel_ERP_NormalNeed3_m_Input();
		this.pa.push(this.formpanel_ERP_NormalNeed3_m_Input);
		this.formname.push("panel_ERP_NormalNeed3_m_Input");
		temp.push(this.formpanel_ERP_NormalNeed3_m_Input);
