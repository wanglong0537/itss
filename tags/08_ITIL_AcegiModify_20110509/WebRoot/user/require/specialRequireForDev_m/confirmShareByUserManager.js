PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequireDevConfirm_m_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit(
					"devsr_m_confirmShareByUserManager",
	...
	getFormpanel_srInfo_input1 : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit(
					"devsr_m_confirmShareByUserManager", "panel_srInfo_input1",
					this.dataId);// 这是要随时变得
		} else {
...
//				"panel_SRprojectContracts", this);
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "devsr_m_confirmShareByUserManager";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel(
				"devsr_m_confirmShareByUserManager", this);
