...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>               
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequire2_m/confirmByTechnicManager.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var pageTemplates = new PageTemplates({dataId:"${param.dataId}",configItemTypeId:citId,taskId:'${param.taskId}',readOnly:"${param.readOnly}"});
	   }
