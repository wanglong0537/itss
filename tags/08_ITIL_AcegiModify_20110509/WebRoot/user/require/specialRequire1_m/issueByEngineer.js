PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequire3_m_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("nsr1_m_issueByEngineer",
...
//		var pnId = sra.getProjectNoticeId(this.dataId);//remove by lee for 修改公告部分BUG直接将公告面板加入 in 20091102
		var items = new Array();
		var pa = new Array();
		this.pa = pa;
		var gd = new Array();
		...
		this.model = "nsr1_m_issueByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("nsr1_m_issueByEngineer",this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
				height : 'auto',
