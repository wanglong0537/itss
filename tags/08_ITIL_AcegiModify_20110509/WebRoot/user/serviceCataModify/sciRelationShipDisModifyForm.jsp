...
<title>config</title>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/user/serviceCataModify/serviceDis_tree.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/user/serviceCataModify/serviceDisComponent.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/extEngine/RowExpander.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/user/serviceCataModify/serviceCatalogueModifyView.js"></script>
<style type="text/css"> 
    #tree1, #tree2 {   
    	float:left;
    	margin:20px;
    ...
    <script type="text/javascript">
    	...
    	Ext.onReady(function(){		
			var panel = new PageModelDisComponentPanel({dataId:'${param.rootCataId}',rootId:'${rootId}',modifyDataId:'${modifyDataId}',rootText:'${rootText}'});
