...
<head>
  <title>≈‰÷√œÓ…Û≈˙◊¥Ã¨≤È—Ø</title>
    <%@include file="/includefiles.jsp"%>	
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/eventAuditQuery/eventAuditSearchForm.js"></script>   	 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/eventAuditQuery/eventAuditPanelList.js"></script>
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){	
	   ...
	   var eventAuditPanel = new EventAuditPanel();
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 autoScroll:true,
	   	 items:[eventAuditPanel]
	   });
	});
