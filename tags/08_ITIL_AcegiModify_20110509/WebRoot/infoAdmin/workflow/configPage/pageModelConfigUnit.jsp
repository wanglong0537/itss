...
.common-text {
	...
	function updateTab(id,title, url) {
	   ...
	   var pageModelConfigUnit = new PageModelConfigUnit({desc:'${param.desc}',nodeId:'${param.nodeId}',virtualDefinitionInfoId:'${param.virtualDefinitionInfoId}'});
	   
	   pageModelConfigUnit.render("configUnitListPanel");
	   
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[pageModelConfigUnit]
	   });
	});
