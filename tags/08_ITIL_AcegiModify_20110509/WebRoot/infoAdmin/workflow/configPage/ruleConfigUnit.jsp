...
.common-text {
	...
	function updateTab(id,title, url) {
	   ...
	   var ruleConfigUnit = new RuleConfigUnit({desc:'${param.desc}',nodeId:'${param.nodeId}',virtualDefinitionInfoId:'${param.virtualDefinitionInfoId}'});
	   
	   ruleConfigUnit.render("configUnitListPanel");
	   
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[ruleConfigUnit]
	   });
	});
