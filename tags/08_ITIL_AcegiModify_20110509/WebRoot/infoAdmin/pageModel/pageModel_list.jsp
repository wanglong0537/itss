...
function loadNewTables(){ 
    var serverPath = "${pageContext.request.contextPath}/pageModel/pageModelManage.do?methodCall=toPageModelEditForm";
...
<TABLE cellSpacing=1 cellPadding=3 width="100%" bgColor=#6298e1 border=0>
  ...
  <FORM name="formSearch" action="${pageContext.request.contextPath}/pageModel/pageModelManage.do" method="post">
...
<TABLE cellSpacing=1 cellPadding=3 width="100%" bgColor=#6298e1 border=0>
  <FORM name="formDel" action="${pageContext.request.contextPath}/pageModel/pageModelManage.do" method="post">
 ...
 <c:forEach  var="item" items="${requestScope.page.data}" varStatus="status">   
  ...
  <TR onmouseover="this.style.backgroundColor = '#FFFFFF'" style="CURSOR: hand" 
    ...
    <A onclick='changeAdminFlag("修改导航栏目")' 
      href="${pageContext.request.contextPath}/pageModel/pageModelManage.do?methodCall=toPageModelEditForm&id=${item.id}">
      ${item.title }
    </A> 
    </TD>
