...
public class VideoConferenceMCU extends BaseObject {
   ...
   private com.zsgj.itil.config.extlist.entity.VideoConfMCUType videoConfMCUType;
...
public com.zsgj.itil.config.extlist.entity.VideoConfMCUType getVideoConfMCUType() {
	return videoConfMCUType;
}
public void setVideoConfMCUType(
		com.zsgj.itil.config.extlist.entity.VideoConfMCUType videoConfMCUType) {
