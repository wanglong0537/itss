...
public class MailForwardApply extends BaseObject {
	...
	private com.zsgj.info.framework.security.entity.UserInfo accountOwner;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final com.zsgj.itil.config.extlist.entity.MailForwardApply other = (com.zsgj.itil.config.extlist.entity.MailForwardApply) obj;
		if (id == null) {
			if (other.id != null)
				return false;
