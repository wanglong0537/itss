...
public class SecurityDevice extends BaseObject {
   ...
   private com.zsgj.itil.config.extlist.entity.SecurityDeviceType securityDeviceType;

   public com.zsgj.itil.config.extlist.entity.SecurityDeviceType getSecurityDeviceType() {
	return securityDeviceType;
}
public void setSecurityDeviceType(
		com.zsgj.itil.config.extlist.entity.SecurityDeviceType securityDeviceType) {
...
public void setId(java.lang.Long id){
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.zsgj.itil.config.extci.entity.SecurityDevice other = (com.zsgj.itil.config.extci.entity.SecurityDevice) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
