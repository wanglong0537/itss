...
public class FireFightingApparatusEvent extends BaseObject {
   ...
   private com.zsgj.itil.config.extlist.entity.FireFightingType type;
   ...
   public void setType(com.zsgj.itil.config.extlist.entity.FireFightingType type){
	     this.type=type;
   }
   ...
   public com.zsgj.itil.config.extlist.entity.FireFightingType getType(){
	     return this.type;
   }
