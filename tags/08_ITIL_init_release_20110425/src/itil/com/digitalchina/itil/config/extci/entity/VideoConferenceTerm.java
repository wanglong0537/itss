...
public class VideoConferenceTerm extends BaseObject {
   ...
   private com.digitalchina.itil.config.extlist.entity.VideoConfTermType videoConfTermType;
   public com.digitalchina.itil.config.extlist.entity.VideoConfTermType getVideoConfTermType() {
	return videoConfTermType;
}
public void setVideoConfTermType(
		com.digitalchina.itil.config.extlist.entity.VideoConfTermType videoConfTermType) {
	this.videoConfTermType = videoConfTermType;
}
public void setId(java.lang.Long id){
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.digitalchina.itil.config.extci.entity.VideoConferenceTerm other = (com.digitalchina.itil.config.extci.entity.VideoConferenceTerm) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
