...
public class ERPinterfaceEvent extends BaseObject {
   private java.lang.Long id;
   private java.lang.String name;
   private java.lang.String techName;
   private com.digitalchina.itil.config.extlist.entity.ERPAccessMode accessMode;
   ...
   public void setAccessMode(com.digitalchina.itil.config.extlist.entity.ERPAccessMode accessMode){
   ...
   public com.digitalchina.itil.config.extlist.entity.ERPAccessMode getAccessMode(){
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.digitalchina.itil.config.extci.entity.ERPinterfaceEvent other = (com.digitalchina.itil.config.extci.entity.ERPinterfaceEvent) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
