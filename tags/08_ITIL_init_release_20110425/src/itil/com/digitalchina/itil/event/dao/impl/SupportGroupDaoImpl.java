...
//			Criteria count=createCriteria(Class.forName("com.digitalchina.itil.actor.entity.ServiceEngineer"+providerType.getDiscValue()))
...
//			Criteria c=createCriteria(Class.forName("com.digitalchina.itil.actor.entity.ServiceEngineer"+providerType.getDiscValue()))
//			.createAlias("userInfo", "user")
//			.setFetchMode("userInfo", FetchMode.JOIN)
//			.setFetchMode("user.department", FetchMode.JOIN)
