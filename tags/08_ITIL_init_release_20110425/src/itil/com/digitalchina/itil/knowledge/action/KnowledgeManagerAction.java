package com.digitalchina.itil.knowledge.action;
...
public class KnowledgeManagerAction extends BaseAction {
	...
	public String apply() throws Exception {
		...
		mapBizz.put("workflowHistory", "com.digitalchina.itil.knowledge.entity.KnowledgeAuditHis");
...
//				userInfo);
		...
		if ("com.digitalchina.itil.knowledge.entity.Knowledge".equals(knowledgeType.getClassName())) {
		...
		} else if ("com.digitalchina.itil.knowledge.entity.KnowFile".equals(knowledgeType.getClassName())) {
			mapBizz.put("workflowHistory", "com.digitalchina.itil.knowledge.entity.KnowFileAuditHis");
			if (engineerList.size() > 0) {
				SupportGroupEngineer engineer = engineerList.get(0);
				if (engineer != null) {
					SupportGroup supportGroup = engineer.getSupportGroup();// 获取工程师对应支持组
			...
			mapBizz.put("workflowHistory", "com.digitalchina.itil.knowledge.entity.KnowContractAuditHis");
			if (engineerList.size() > 0) {
				SupportGroupEngineer engineer = engineerList.get(0);
				if (engineer != null) {
					SupportGroup supportGroup = engineer.getSupportGroup();// 获取工程师对应支持组
