		...
		this.formpanel_NewITAccountApply_Input = new Ext.form.FormPanel({
			...
			items:[ 
			{
				html : '<font size=2px> 邮件帐号：<a href="http://bjas2/ITHELPME.nsf/00dc6ddbfdcfea6848256d59001efa87/0e38eaf770fbad8e48256ffe002bd630?OpenDocument" target="_blank" style="text-decoration:none"><b>NOTES6安装配置方法</b></a>&nbsp&nbsp&nbsp&nbsp&nbsp<a href="http://bjas2/ITHELPME.nsf/00dc6ddbfdcfea6848256d59001efa87/439e87119e2c1d4a48256d6a00184d39?OpenDocument" target="_blank" style="text-decoration:none"><b>如何修改Notes口令</b></a>' +
						'<br>域帐号：<a href="http://bjas2/ITHELPME.nsf/00dc6ddbfdcfea6848256d59001efa87/79b62bb229f9a89548256e9200291908?OpenDocument" target="_blank" style="text-decoration:none"><b>如何加入digitalchina域（WinXP用户）</a>自动加入域.exe</b>' +
		  ...
		  },
		  {
		   ...
		   style : 'border:1px dotted #b0acac;margin:5px 0px 0px 25px',
			...
			items:[
			{
				html : '<font color=red>*</font>您的DIGITALCHINA域帐号是:',
				cls : 'common-text',
		...
		
			{
				...
				style : 'text-align:left',
				colspan : 2,
			    html : ' 1、其初始密码为password123。<br>2、当您拿到邮件帐号和域帐号之后，就可以正确配置您的计算机名并将计算机加入DIGITALCHINA域了。<br>3、第一次登录域时，系统一般会提示您更改密码，具体操作方法请见：WIN98系统： WIN2000系统： WINXP系统：</font> '
			}
