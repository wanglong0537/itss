...
//modify by liuying for 修改原邮件服务器为文本框 at 20100514 end
		...
		if (this.dataId == "0" || this.dataId == "null") {
				...
				Ext.getCmp("itil_ac_DCContacts$sameMailDeptCombo").initComponent();
		...
		var viewConfig = Ext.apply({
			forceFit : true
			 ...
			 columns : [{header : '自动编号',dataIndex : 'id',align : 'left',sortable : true,hidden : true}, 
						...
						{header : '<font color=red>是否保留</font>',dataIndex : 'ifHold',align : 'center',sortable : true,hidden : false,editor:new Ext.grid.GridEditor(new Ext.form.ComboBox({
				xtype : 'combo',
			...
			})),renderer:function(value,record){if(value==1)
