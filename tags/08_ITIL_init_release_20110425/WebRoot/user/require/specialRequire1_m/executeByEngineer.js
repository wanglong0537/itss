PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequire3_m_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("nsr1_m_executeByEngineer",
...
//add by lee for add attachmentfile in 20090806 begin
	...
	initComponent : function() {
		...
		this.model = "nsr1_m_executeByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("nsr1_m_executeByEngineer",
				this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
