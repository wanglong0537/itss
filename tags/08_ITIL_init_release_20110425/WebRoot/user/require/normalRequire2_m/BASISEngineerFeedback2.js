PageTemplates = Ext.extend(Ext.Panel, {
	...
	saveAndSubmit : function() {
		...
		Ext.Ajax.request({
			...
			params : {
				...
				model : 'nr_m_BASISEngineerFeedback2'
			},
	...
	getFormpanel_ERP_NormalNeed1_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("nr_m_BASISEngineerFeedback2",
	...
	initComponent : function() {
		...
		this.model = "nr_m_BASISEngineerFeedback2";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel(
				"nr_m_BASISEngineerFeedback2", this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
				height : 'auto',
