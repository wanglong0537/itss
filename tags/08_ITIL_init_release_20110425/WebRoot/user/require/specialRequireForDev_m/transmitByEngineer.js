PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequireDevConfirm_m_Input : function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("devsr_m_transmitByEngineer",
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "devsr_m_transmitByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("devsr_m_transmitByEngineer", this);
