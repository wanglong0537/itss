PageTemplates = Ext.extend(Ext.Panel, {
	...
	saveAndSubmit : function() {
		var formParam = Ext.getCmp('panel_SpecialRequire4_m_Input').form
				.getValues(false);
		var vp = null;
		if (formParam != null) {
	...
	initComponent : function() {
		...
		this.model = "sr2_m_confirmByITManager";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("sr2_m_confirmByITManager",
				this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
