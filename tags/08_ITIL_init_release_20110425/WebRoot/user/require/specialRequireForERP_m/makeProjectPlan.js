PageTemplates = Ext.extend(Ext.Panel, {
	...
	saveAndSubmit : function() {
		...
		var formParam = Ext.getCmp('panel_srInfo_input1').form.getValues(false);
		var vp = null;
		if (formParam != null) {
...
//申请主面板	
 getFormpanel_erpSR_it_m_input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("esr_m_makeProjectPlan",
...
//   },
	...
	initComponent : function() {
		...
		this.model = "esr_m_makeProjectPlan";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel(
				"esr_m_makeProjectPlan", this);
