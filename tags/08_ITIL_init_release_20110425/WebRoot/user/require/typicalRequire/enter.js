...
//	title :this.description,
	...
	save : function() {
		...
		if(!Ext.getCmp('panel_typicalRequire_Input').form.isValid()){
		...
		var formParam = Ext.encode(getFormParam('panel_typicalRequire_Input',false));
		Ext.Ajax.request({
			url : webContext + '/requireAction_saveApplyDraft.action',
			params : {
				pagePanel　:　'panel_typicalRequire_Input',
				info : formParam,
	...
	saveAndSubmit : function() {
		...
		Ext.Ajax.request({
			url : webContext + '/requireAction_saveApplyDraft.action',
			params : {
				panel　:　'panel_typicalRequire_Input',
				pagePanel　:　'panel_typicalRequire_Input',
				info : formParam,
				serviceItemId : curscid
			},
      ...
      var da = new DataAction();
		  var data = null;
			...
			var biddata = "";
			  ...
			  this.getFormButtons = buttonUtil.getButtonForPanel("panel_typicalRequire_Input",this);
			if (this.dataId == '0') {
				data = da.getRequireFormPanelElementsForEdit("panel_typicalRequire_Input","");
			}else{
				data = da.getRequireFormPanelElementsForEdit("panel_typicalRequire_Input",this.dataId);
			}
