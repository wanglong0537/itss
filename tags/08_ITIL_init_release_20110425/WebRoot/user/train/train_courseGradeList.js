PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("panel_trainCourseGrade"); //da.getElementsForQuery("com.digitalchina.itil.train.entity.TrainCourseGrade");
...
//				this.pageBar.formValue = this.formValue;
	...
	removeTrain : function(){
		var store = this.store;
				...
				var clazz = "com.digitalchina.itil.train.entity.TrainCourseGrade";		
					if(!record){
			...
			if (button == 'yes') {	
				for(var i=0;i<records.length;i++){
					...
					var scId = records[i].get("TrainCourseGrade$id");
							Ext.Ajax.request({
	...
	initComponent : function(){
        ...
        this.mybuttons=buttonUtil.getButtonForModel("page_train_courseGrade_list",this);
		this.fp = this.getSearchForm();
		 this.modelTableName="TrainCourseGrade";
		var obj = da.getListPanelElementsForHead("panel_trainCourseGrade");
		...
		for (var i = 0; i < obj.length; i++) {
			...
			if(propertyName=='TrainCourseGrade$deleteFlag'){
				isHiddenColumn = true;
			}
		...
		this.store = da.getPanelJsonStore("panel_trainCourseGrade",obj); //add header 
