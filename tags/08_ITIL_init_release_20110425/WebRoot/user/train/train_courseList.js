PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("panel_trainCourse"); //da.getElementsForQuery("com.digitalchina.itil.train.entity.TrainCourse");
...
//				this.pageBar.formValue = this.formValue;
	...
	removeTrain : function(){
		var store = this.store;
				...
				var clazz = "com.digitalchina.itil.train.entity.TrainCourse";		
					if(!record){
