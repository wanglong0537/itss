PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("panel_trainAnswer"); // da.getElementsForQuery("com.digitalchina.itil.train.entity.QuestOption");
...
//			this.pageBar.formValue = this.formValue;
	...
	remove : function() {
		...
		var clazz = "com.digitalchina.itil.train.entity.QuestOption";
		if (!record) {
...
//		alert("dataId" + dataId);
	...
	getPanel : function() {
		//alert(dataId);
		var da = new DataAction();
		var clazz = "com.digitalchina.itil.train.entity.Quest";
