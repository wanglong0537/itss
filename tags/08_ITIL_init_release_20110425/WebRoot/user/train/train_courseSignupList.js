PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("panel_trainCourseSignup"); //da.getElementsForQuery("com.digitalchina.itil.train.entity.TrainCourseSignup");
...
//				this.pageBar.formValue = this.formValue;
	...
	removeTrain : function(){
		var store = this.store;
				...
				var clazz = "com.digitalchina.itil.train.entity.TrainCourseSignup";		
					if(!record){
