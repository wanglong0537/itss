 ...
 <form name="editForm" id="editForm" action="${pageContext.request.contextPath}/infoAdmin/userListMainTable.do" 
  ...
  <tr>  
    ...
    <td width="40%" bgcolor="#EFF3FF">
     <input name="className" id="className" type="hidden" class="textfield" style="WIDTH:400px;" value="${empty smt?'com.digitalchina.itil.config.extlist.entity':smt.className}">      
   ${empty smt?'com.digitalchina.itil.config.extlist.entity':smt.className}
   </td>
