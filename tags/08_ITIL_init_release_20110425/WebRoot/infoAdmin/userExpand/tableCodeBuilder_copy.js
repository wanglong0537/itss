PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("panel_tableCodeBuilder"); //da.getElementsForQuery("com.digitalchina.info.appframework.metadata.entity.SystemMainTableIdBuilder");
