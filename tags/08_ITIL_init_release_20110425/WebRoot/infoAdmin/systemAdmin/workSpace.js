PagePanel = Ext.extend(Ext.Panel, {
	...
	create : function() {
		var clazz = "com.digitalchina.info.framework.security.entity.WorkSpace";//指定实体类型
	...
	initComponent : function() {//初始化面板
		...
		this.grid = new Ext.grid.GridPanel({//设定grid
			...
			columns : [sm, {header : '编号',dataIndex : 'id',align : 'left',sortable : true,hidden : true}, 
						{header : '工作地点',dataIndex : 'name',align : 'left',sortable : true,hidden : false,width:200},
						{header : '邮件服务器',dataIndex : 'mailServer',align : 'left',sortable : true,hidden : false,width:250}
