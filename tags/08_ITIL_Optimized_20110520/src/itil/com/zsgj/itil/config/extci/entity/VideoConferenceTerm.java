...
public class VideoConferenceTerm extends BaseObject {
   ...
   private com.zsgj.itil.config.extlist.entity.VideoConfTermType videoConfTermType;
   public com.zsgj.itil.config.extlist.entity.VideoConfTermType getVideoConfTermType() {
	return videoConfTermType;
}
public void setVideoConfTermType(
		com.zsgj.itil.config.extlist.entity.VideoConfTermType videoConfTermType) {
...
public void setId(java.lang.Long id){
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.zsgj.itil.config.extci.entity.VideoConferenceTerm other = (com.zsgj.itil.config.extci.entity.VideoConferenceTerm) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
