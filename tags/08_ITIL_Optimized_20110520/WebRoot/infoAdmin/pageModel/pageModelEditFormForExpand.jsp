...
<table width="98%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
 <form name="editForm" id="editForm" action="${pageContext.request.contextPath}/pageModel/pageModelExpandManage.do" method=post>
  <tr>
  ...
  <tr>
	...
	<td width="10%" bgcolor="#EFF3FF">
      ...
      <td width="40%" bgcolor="#EFF3FF">&nbsp;
      <input class=button type="button" name="Submit" onclick="genModelCode();" value="生成页面代码uuuuuu" >
      </td>   
    </tr>
  </form>
</table>  
