...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
 <form name="editForm" id="editForm" action="${pageContext.request.contextPath}/infoAdmin/sysTableQuery.do?methodCall=saveQuery" method=post>
 
  <tr>
    <td width="10%" align="center" bgcolor="#EFF3FF">系统查询关键字</td>
    <td width="40%" bgcolor="#EFF3FF">
    <input name="id"  id="id"   type="hidden" value="${detail.id}">
    
    <input name="queryName" id="queryName"  type="text" class="textfield" style="WIDTH:250px;" value="${detail.queryName}"></td>
    <td width="10%" bgcolor="#EFF3FF">系统查询名称</td>
    <td width="40%" bgcolor="#EFF3FF">
    <input name="queryCnName"  id="queryCnName" type="text" class="textfield" style="WIDTH:150px;" value="${detail.queryCnName}"></td>
  </tr>
  <tr>
    <td align="center" bgcolor="#EFF3FF">系统查询类型</td>
    <td bgcolor="#EFF3FF">
	<select name="queryType" id="queryType" style="width:100px;" class="textfield">
       <option value="1">单表查询</option>
       <option value="2">复合查询</option>
    </select>
	</td>
    <td bgcolor="#EFF3FF">所属主表</td>
    <td bgcolor="#EFF3FF">
  
    <select name="systemMainTable" id="systemMainTable" style="width:100px;" class="textfield">
       <option value=""></option>
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#EFF3FF"><input class=button type="submit" name="Submit" value="保存系统查询" >
    </td>
  </tr>
  <tr><td></td></tr>
  </form>
