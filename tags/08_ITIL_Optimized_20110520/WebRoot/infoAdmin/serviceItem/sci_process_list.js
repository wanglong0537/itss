...
//									this.store.load({
//										callback : function(r, options, success) {
//											Ext.getCmp('ServiceItemProcess$sidProcessTypeCombo').setValue(Ext.getCmp('ServiceItemProcess$sidProcessTypeCombo').getValue());
//										}
//									});
//								}
							})]
...
//														.getCmp('ServiceItemProcess$pageListPanelCombo').defaultParam;
//											}
//										}
//									},
//									totalProperty : 'rowCount',
...
//										},
//										callback : function(r, options, success) {
//											Ext.getCmp('ServiceItemProcess$pageListPanelCombo').setValue(Ext.getCmp('ServiceItemProcess$pageListPanelCombo').getValue());
//										}
//									});
//								}
//							})]
...
//								store : new Ext.data.JsonStore({
//									url : webContext
//											+ '/sciProcess_getSmtComboData.action',
//									// +
...
//												opt.params['tableName'] = Ext
//														.getCmp('ServiceItemProcess$reqTableCombo').defaultParam;
//											}
//										}
//									},
//									totalProperty : 'rowCount',
...
//										params : {
//											id : Ext
//													.getCmp('ServiceItemProcess$reqTableCombo')
//													.getValue(),
//											start : 0
//										},
//										callback : function(r, options, success) {
...
//						}, 
	...
	initComponent : function() {
		...
		this.store = new Ext.data.JsonStore({
			//url : webContext+ '/infoAdmin/serviceItemProcessAction.do?methodCall=listSciProcess&serviceItemId='+ this.serviceItemId,
			url : webContext+ '/sciProcess_listSciProcess.action?serviceItemId='+ this.serviceItemId,
