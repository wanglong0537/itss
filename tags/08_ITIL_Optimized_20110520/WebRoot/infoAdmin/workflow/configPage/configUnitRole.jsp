...
<head> 
  ...
  <%@include file="/includefiles.jsp"%>  
	...
	<script type="text/javascript" src="<c:url value="/js/TabCloseMenu.js"/>"></script> 
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/configUnitRolePanel.js"></script>
  	  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/configUnitRoleAddPanel.js"></script>
  	<style type="text/css">  
		.x-head{ 
   ...
   <script type="text/javascript">
	...
	function updateTab(id,title, url) {
	   ...
	   var configUnitRoleListPanel = new ConfigUnitRoleListPanel();
	   
	   
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[configUnitRoleListPanel]
	   });
	});
