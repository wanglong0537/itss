  ...
  <title>流程监控</title>
	...
	<script type="text/javascript" src="<c:url value="/js/TabCloseMenu.js"/>"></script> 
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/actionConfigUnit.js"></script>
  	  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/processMonitor.js"></script>
	<style type="text/css">  
		.x-head{ 
	...
	function updateTab(id,title, url) {
	   ...
	   var processMonitorGridPanel = new ProcessMonitorGridPanel();
	   
	   processMonitorGridPanel.render("processMonitorGridPanel");
	   
	   new Ext.Viewport({
	     
	   	 layout:'fit',
	   	 items:[processMonitorGridPanel]
	   });
	});
...
<div id="processMonitorGridPanel" style="height:100%"></div>
