...
<style type="text/css">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/user/sysTable/modifyForm.js"></script>
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/sysTable/borrowBookForm.js"></script>
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/sysTable/GridModifyPanel.js"></script>
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/sysTable/GridModifyPanel2.js"></script>
   <script type="text/javascript" src="${pageContext.request.contextPath}/user/sysTable/ModifyPanel.js"></script>
   ...
   <script type="text/javascript">
    	...
    	Ext.onReady(function(){
    		...
    		//alert("aaaa"+id);
    		//var modifyForm = new ModifyForm({id:'${param.id}'});			
