...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/service/serviceListPanel.js"></script> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/service/serviceSearchForm.js"></script>   
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){	
	   ...
	   var serviceListPanel = new ServiceListPanel();

	   serviceListPanel.render("configItem");

	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[serviceListPanel]
	   });
...
<div id="configItem" style="height:100%"></div>
