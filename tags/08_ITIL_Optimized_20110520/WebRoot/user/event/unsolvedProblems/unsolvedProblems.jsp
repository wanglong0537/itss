...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/user/event/unsolvedProblems/unsolvedProblems.js"></script>
		<script type="text/javascript">
  			var taskId = '${taskId}';
	...
	Ext.onReady(function(){	
		...
		var problemManagerPanel = new ProblemManagerPanel();
		problemManagerPanel.render("problemManagerPanel");
	    new Ext.Viewport({
	   		layout : 'fit',
	   		items : [problemManagerPanel]
	    });
	});
	...
	<body onload="changeSkin('${userInfo.userViewStyle}');">
		<div id="problemManagerPanel" style="height: 100%"></div>
