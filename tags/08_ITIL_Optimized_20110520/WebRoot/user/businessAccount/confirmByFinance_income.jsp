...
<%@include file="/includefiles.jsp"%>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/user/businessAccount/confirmByFinance_income.js"></script>
    ...
    <script type="text/javascript">
    	...
    	Ext.onReady(function(){
    		...
    		var panel = new Ext.Panel({
						...
						//remove by lee for 收款申请时财务不能拒绝 in 20091103 begin
						//,{
						//	text : "拒绝",
						//	iconCls : "remove",
						//	handler : function() {
						...
						//	scope : this
						//}
						//remove by lee for 收款申请时财务不能拒绝 in 20091103 end
						]
					});			
			panel.render("panel");
			new Ext.Viewport({
