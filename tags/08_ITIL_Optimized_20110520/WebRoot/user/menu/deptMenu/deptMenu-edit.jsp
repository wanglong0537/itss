	...
	<script type="text/javascript">
		function checkForm(){
			...
			if(xform.title.value == ""){
				...
				xform.action="${pageContext.request.contextPath}/servlet/deptMenuSave";   
	    		xform.submit(); 	
    		}
		}
	</script>
...
<body style="background-color: white">
	<br/><br/>
	<form id="myForm" action="${pageContext.request.contextPath}/servlet/deptMenuSave" method="post">
		...
		<input type="hidden" name="dmtId" value="${obj.deptMenuTemplate.id}"/>
