...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>                          
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemBatchModify/configItemRelForModify.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var rid="${param.rid}"
		var relForModifyPanel=new RelForModifyPanel({rid:rid});
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[relForModifyPanel]
	   });
	});
