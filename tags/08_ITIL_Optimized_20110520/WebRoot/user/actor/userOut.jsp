...
<head>
 ...
 <%@include file="/includefiles.jsp"%>  
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/organization/userOutDetail.js"></script> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/organization/userOut.js"></script>
	<style type="text/css">
	html, body {
