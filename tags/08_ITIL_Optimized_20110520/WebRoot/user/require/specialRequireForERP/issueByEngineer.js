PageTemplates = Ext.extend(Ext.Panel, {
	...
	saveAndSubmit : function() {
		...
		var formParam = Ext.encode(getFormParam('panel_srInfo_input4ForERP'));
 ...
 * **/			window.parent.auditContentWin.specialAudit();	
	...
	getFormpanel_erpSR_it_input : function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("esr_issueByEngineer",
...
//					data[i] = Ext.decode(dd);
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "esr_issueByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel(
				"esr_issueByEngineer", this);
