PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequireDev_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("devsr_confirmByFinance",
	...
	initComponent : function() {
		...
		this.model = "devsr_confirmByFinance";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("devsr_confirmByFinance",
				this);
