...
SpecialRequireAction = Ext.extend(Ext.util.Observable,{
	...
	getReqServiceItemId:function(reqId){
		alert(reqId);
		var url = webContext+'/specialRequireAction_getReqServiceItemIdNew.action?reqId='+reqId;
		var data = this.ajaxGetPage(url);
		var siId = data.id;
		return siId;
	},
	...
	getReqServiceProviderId:function(reqId){
		var url = webContext+'/specialRequireAction_getReqServiceProviderIdNew.action?reqId='+reqId;
	    var data = this.ajaxGetPage(url);
		var spId = data.id;
		return spId;
	},
