ConfigItemAddInfo = Ext.extend(Ext.Panel, {
	...
	initComponent : function() {
		...
		var curreqCls = this.reqCls;
		 	Ext.getCmp('ConfigItem$configItemTypeCombo').addListener('change', function(box, newv, oldv) {
       				if(newv!=citId){
                    window.location= webContext+'/user/require/specialRequireForERP/configItemAddInfo.jsp?configItemTypeId='+newv+'&parentId='+curParentId+'&order='+curOrder+'&shipPicId='+curShipPicId+'&dtId='+curreqId+'&reqClass='+curreqCls;
                    }
    			});
				...
				Ext.Ajax.request({
					...
					success : function(response, options) {
						...
						Ext.MessageBox.alert("提示","保存成功",function(){
							window.location = webContext+'/user/require/specialRequireForERP/makeProjectPlan.jsp?dataId='+reaId+'&reqClass='+reaClass+'&tabNumber='+'tree';
	...
	goBackByPage:function(){
		...
		var reaBackClass =this.reqCls;
		window.location = webContext+'/user/require/specialRequireForERP/makeProjectPlan.jsp?dataId='+reaBackId+'&reqClass='+reaBackClass+'&tabNumber='+'tree';
	},
	worksubmit : function(){
		//alert("================"+"启动工作流"+"======================");
		//alert("=="+this.dataId+"==");
