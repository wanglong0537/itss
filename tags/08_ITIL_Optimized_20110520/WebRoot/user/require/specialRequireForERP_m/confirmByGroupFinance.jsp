...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/confirmByGroupFinance.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var pageTemplates = new PageTemplates({dataId:"${param.dataId}",reqClass:"${param.reqClass}",configItemTypeId:citId,readOnly:"${param.readOnly}"});
	   }
