PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_ERP_NormalNeed1_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("nr_EBEngineerFeedback2",
	...
	initComponent : function() {
		...
		this.model = "nr_EBEngineerFeedback2";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("nr_EBEngineerFeedback2",
				this);
