 ...
 * @Create In 2008-4-14
 */
public class InitActionHandler extends BaseActionHandler implements WorkflowConstants,ActionHandler{
	private static Log log;
	static 
	{
		log = LogFactory.getLog(com.zsgj.info.framework.workflow.handler.InitActionHandler.class);
	}
	/**
...
//		String nodeName = executionContext.getNode().getName();	
	...
	public InitActionHandler() {		
	}
	
	public InitActionHandler(String configuration){
