...
import com.digitalchina.itil.finance.entity.ApportionMode;
...
public class ConfigItemFinanceInfoEvent extends BaseObject {
	public static int CIF_DELETE = -1;// 已删除(逻辑删除)
	private Long id;
	...
	public int hashCode() {
		final int PRIME = 31;
		int result = 1;
		result = PRIME * result + ((configItemEvent == null) ? 0 : configItemEvent.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final ConfigItemFinanceInfoEvent other = (ConfigItemFinanceInfoEvent) obj;
		if (configItemEvent == null) {
			if (other.configItemEvent != null)
				return false;
		} else if (!configItemEvent.equals(other.configItemEvent))
			return false;
		if (id == null) {
			if (other.id != null)
				return false;
