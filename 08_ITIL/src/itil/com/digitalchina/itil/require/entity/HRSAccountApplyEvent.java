...
public class HRSAccountApplyEvent extends BaseObject {
	...
	private com.digitalchina.itil.require.entity.HRSAccountApply oldApply;
	...
	private com.digitalchina.itil.config.extlist.entity.HRSUserRight userRight;
	private com.digitalchina.itil.config.extlist.entity.HRSOperationScope operationScope;
	...
	private com.digitalchina.itil.config.extlist.entity.HRSAccountManger accountManger;
	...
	public void setOldApply(
			com.digitalchina.itil.require.entity.HRSAccountApply oldApply) {
	...
	public void setUserRight(
			com.digitalchina.itil.config.extlist.entity.HRSUserRight userRight) {
		this.userRight = userRight;
	}

	public void setOperationScope(
			com.digitalchina.itil.config.extlist.entity.HRSOperationScope operationScope) {
	...
	public void setAccountManger(
			com.digitalchina.itil.config.extlist.entity.HRSAccountManger accountManger) {
	...
	public com.digitalchina.itil.require.entity.HRSAccountApply getOldApply() {
	...
	public com.digitalchina.itil.config.extlist.entity.HRSUserRight getUserRight() {
		return this.userRight;
	}

	public com.digitalchina.itil.config.extlist.entity.HRSOperationScope getOperationScope() {
	...
	public com.digitalchina.itil.config.extlist.entity.HRSAccountManger getAccountManger() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final com.digitalchina.itil.require.entity.HRSAccountApplyEvent other = (com.digitalchina.itil.require.entity.HRSAccountApplyEvent) obj;
		if (id == null) {
			if (other.id != null)
				return false;
