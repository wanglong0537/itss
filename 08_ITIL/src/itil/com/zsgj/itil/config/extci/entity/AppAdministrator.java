...
public class AppAdministrator extends BaseObject {
	/**
	 * @Field long serialVersionUID
	 */
	private static final long serialVersionUID = 9202155385236201746L;
	private java.lang.Long id;
	private com.zsgj.info.framework.security.entity.Department deptInfo;
	private com.zsgj.info.framework.security.entity.UserInfo userInfo;
	...
	public void setDeptInfo(
			com.zsgj.info.framework.security.entity.Department deptInfo) {
		this.deptInfo = deptInfo;
	}

	public void setUserInfo(
			com.zsgj.info.framework.security.entity.UserInfo userInfo) {
	...
	public com.zsgj.info.framework.security.entity.Department getDeptInfo() {
		return this.deptInfo;
	}

	public com.zsgj.info.framework.security.entity.UserInfo getUserInfo() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final com.zsgj.itil.config.extci.entity.AppAdministrator other = (com.zsgj.itil.config.extci.entity.AppAdministrator) obj;
		if (id == null) {
			if (other.id != null)
				return false;
