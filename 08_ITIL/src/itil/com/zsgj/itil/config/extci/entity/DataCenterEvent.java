...
public class DataCenterEvent extends BaseObject {
   private com.zsgj.itil.config.extci.entity.OfficeLocation officeLocation;
   ...
   public void setOfficeLocation(com.zsgj.itil.config.extci.entity.OfficeLocation officeLocation){
   ...
   public com.zsgj.itil.config.extci.entity.OfficeLocation getOfficeLocation(){
