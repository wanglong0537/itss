...
public class ServiceItemManagerAction extends BaseAction{
...
//			//需要进入上下文的业务参数
			...
			if(buzzParameters!=null&&!buzzParameters.equals("")) {
				...
				ServiceItem serviceItem = (ServiceItem) service.find(ServiceItem.class, dataId, true);
				if(serviceItem!=null){
					mapBizz.put("applyName", serviceItem.getName());
				}
