...
import com.zsgj.itil.finance.entity.BatchType;
...
//			kcah.setObjType(kcah.OBJTYPE_KNOWLEDGECONTRACT);
	...
	public void knowledgeStartFlag(String dataId, String dataType,String nodeId,String nodeName, String processId){
		...
		if(classNameString.endsWith("com.zsgj.itil.knowledge.entity.KnowFile")) {//文件类型
		...
		}else if(classNameString.endsWith("com.zsgj.itil.knowledge.entity.Knowledge")) {//解决方案类型
