...
public class SpecialAccount extends BaseObject {
	...
	private com.zsgj.info.framework.security.entity.UserInfo accountOldUser; // 帐号原所有者
	private com.zsgj.info.framework.security.entity.UserInfo accountNowUser; // 帐号现所有者
...
//	}
	...
	public com.zsgj.info.framework.security.entity.UserInfo getAccountOldUser() {
		return accountOldUser;
	}

	public void setAccountOldUser(
			com.zsgj.info.framework.security.entity.UserInfo accountOldUser) {
		this.accountOldUser = accountOldUser;
	}

	public com.zsgj.info.framework.security.entity.UserInfo getAccountNowUser() {
		return accountNowUser;
	}

	public void setAccountNowUser(
			com.zsgj.info.framework.security.entity.UserInfo accountNowUser) {
