...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>                          
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemBatchModify/configItemInfoForLook.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var dataId="${param.dataId}"
		var configItemInfo=new ConfigItemInfo({dataId:dataId});
	   new Ext.Viewport({
	   	 layout:'fit',
