...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>                          
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemBatchModify/configItemInfoReadOnly.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var pid="${param.pid}"
		var configItemInfo=new ConfigItemInfo({dataId:dataId,oldId:oldId,modifyId:modifyId,pid:pid});
	   new Ext.Viewport({
	   	 layout:'fit',
