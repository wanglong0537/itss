...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>                          
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/configItem/configItemBatchModify/configItemInfoMaintenanceRelReadyOnly.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var pid="${param.pid}"
		var configItemInfo=new ConfigItemInfo({dataId:dataId,modifyId:modifyId,pid:pid});
	   new Ext.Viewport({
	   	 layout:'fit',
