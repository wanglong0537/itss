PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("panel_trainPlan"); //da.getElementsForQuery("com.zsgj.itil.train.entity.TrainPlan");
...
//				this.pageBar.formValue = this.formValue;
	...
	removeTrain : function(){
		var store = this.store;
				...
				var clazz = "com.zsgj.itil.train.entity.TrainPlan";		
					if(!record){
