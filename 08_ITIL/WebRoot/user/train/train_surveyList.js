PagePanel = Ext.extend(Ext.Panel, {
	...
	getSearchForm : function() {
		...
		var data = da.getPanelElementsForQuery("page_trainSurvey"); // da.getElementsForQuery("com.digitalchina.itil.train.entity.Survey");
	...
	removeSurvey : function() {
		...
		var clazz = "com.digitalchina.itil.train.entity.Survey";
		if (!record) {
