...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/user/serviceCatalogueAuditQuery/serviceCatalogueAuditHis.js"></script>
<style type="text/css">
.x-head {
...
.common-text {
	...
	Ext.onReady(function(){	
	   ...
	   var applyForm = null;	   
	   	...
	   	histroyForm = new ServiceCatalogueHistroyForm({dataId:'${param.dataId}',processId:'${param.processId}'});	
	   	  
	  // orderInfoForm.render("orderApplyInfo");
