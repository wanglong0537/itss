...
<html>
<head>
  <title>服务目录审批状态查询</title>
    <%@include file="/includefiles.jsp"%>	
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/serviceCatalogueAuditQuery/serviceCatalogueAuditSearchForm.js"></script>   	 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/serviceCatalogueAuditQuery/serviceCatalogueAuditPanelList.js"></script>
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){	
	   ...
	   var serviceCatalogueAuditPanel = new ServiceCatalogueAuditPanel();
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 autoScroll:true,
	   	 items:[serviceCatalogueAuditPanel]
	   });
	});
