...
<head>
  <title>≈‰÷√œÓ…Û≈˙◊¥Ã¨≤È—Ø</title>
    <%@include file="/includefiles.jsp"%> 	
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/knowledgeAuditQuery/knowContractAuditSearch.js"></script>
	<style type="text/css"> 
		.x-head{
	...
	Ext.onReady(function(){	
	   ...
	   var knowContractAuditPanel = new KnowContractAuditPanel();
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[knowContractAuditPanel]
	   });
	});
