...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/user/knowledgeAuditQuery/knowContractAuditHis.js"></script>
<style type="text/css">
.x-head {
...
.common-text {
	...
	Ext.onReady(function(){	
	   ...
	   var applyForm = null;	   
	   	var histroyForm = new ContractHistroyForm({dataId:'${param.dataId}'});	
