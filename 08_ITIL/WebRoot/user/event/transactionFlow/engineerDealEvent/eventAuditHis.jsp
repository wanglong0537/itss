...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/user/event/transactionFlow/engineerDealEvent/eventAuditHis.js"></script>
<style type="text/css">
.x-head {
...
.common-text {
	...
	Ext.onReady(function(){	
	   ...
	   Ext.state.Manager.setProvider(new Ext.state.CookieProvider());
	   	...
	   	var histroyForm = new HistroyForm({dataId:'${param.dataId}'});	
