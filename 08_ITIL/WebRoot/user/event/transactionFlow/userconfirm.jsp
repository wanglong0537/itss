...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/event/transactionFlow/userconfirm.js"></script> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/event/transactionFlow/eventAuditHis.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var pageTemplates = new PageTemplates({dataId:"${param.dataId}",processId:"${param.processId}", taskId : "${taskId}"});
	   }
