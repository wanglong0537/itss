PagePanel = Ext.extend(Ext.Panel, {
  ...
  modifyForModelByPage:function(){
		...
		if(records.length>1){
  		...
  		//alert(dataId+"data");
  		window.location= webContext+"/sciRelationShip_getRootRelationShipData.action?rootCataId="+dataId+"&type=keep";
	...
	initComponent : function(){
        ...
        this.mybuttons=buttonUtil.getButtonForModel("page_ServiceCatalogueKeep",this);
		...
		this.grid.on("rowdblclick", this.modifyForModelByPage, this);//lookInPage
