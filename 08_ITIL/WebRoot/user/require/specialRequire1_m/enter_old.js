 ...
 getFormpanel_SpecialRequire3_m_Input: function() {
      var da = new DataAction();
		  var data = null;
			...
			var biddata = "";
			  ...
			  this.getFormButtons = buttonUtil.getButtonForPanel("panel_SpecialRequire3_m_Input",this);
			if (this.dataId != '0') {
				data = da.getPanelElementsForEdit("sr1_m_enter", "panel_SpecialRequire3_m_Input", this.dataId);// 这是要随时变得
  ...
  items : this.items,
	...
	initComponent : function() {
		...
		this.model="sr1_m_enter";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("sr1_m_enter",this);
		if(this.mybuttons!=""){
			this.buttons = {
			layout : 'table',
			height : 'auto',
