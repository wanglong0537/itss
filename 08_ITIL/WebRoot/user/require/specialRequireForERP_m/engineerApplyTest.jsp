...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>		                                                        
 	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/engineerApplyTest.js"></script> 
 	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/projectRenderList.js"></script> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/projectPlanListReadOnly.js"></script> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/serviceORconfigRelInfo_Tree.js"></script> 
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/configItemAddList.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/configItemAddInfo.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/dwr/specialRequireForERP/RequirementCIRelationManager.js"></script>
