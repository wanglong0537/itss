...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/require/specialRequireForERP_m/specailRequire1.js"></script> 
	...
	Ext.onReady(function(){	
	   ...
	   var pageTemplates = new PageTemplates({
						   		...
						   		serviceItemProcessId:'${serviceItemProcessId}',
						   		processId:'${processId}',
