PageTemplates = Ext.extend(Ext.Panel, {
 ...
 getFormpanel_erpSR_it_m_input: function() {
		...
		this.getFormButtons = buttonUtil.getButtonForPanel("panel_erpSR_it_m_input",this);
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("esr_m_transmit", "panel_erpSR_it_m_input", this.dataId);// 这是要随时变得
		} else {
	...
	getFormpanel_srInfo_input4ForERP : function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("esr_m_transmit",
  ...
  buttons : this.buttons,
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "esr_m_transmit";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("esr_m_transmit", this);
