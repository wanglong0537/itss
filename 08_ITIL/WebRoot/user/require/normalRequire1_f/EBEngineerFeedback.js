PageTemplates = Ext.extend(Ext.Panel, {
	...
	savif(!Ext.getCmp('panel_EBEngineerFeedback_Input').form.isValid()){
	...
	getFormpanel_ERP_NormalNeed4_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("nrf_EBEngineerFeedback",
...
//remove by lee for BASIS工程师处理环节被用户去除 in 20091202 end
	...
	initComponent : function() {
		...
		this.model = "nrf_EBEngineerFeedback";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("nrf_EBEngineerFeedback",
				this);
