...
// addy by zhangzy for 售前申请改为一个实体 in 2009 12 9 start	
	getFormpanel_SpecialRequire3Confirm_Input : function() {
		...
		for(var i = 0; i < data.length; i++){
			if(data[i].id!="SpecialRequirement$includeAndExpend"){
...
//		this.model = "sr3_executeByEngineer";
//		var buttonUtil = new ButtonUtil();
//		this.mybuttons = buttonUtil.getButtonForModel("sr3_executeByEngineer",
//				this);
//		if (this.mybuttons != "") {
//			this.buttons = {
//				layout : 'table',
...
//		this.getFormpanel_srInfo_input5();
//		this.pa.push(this.formpanel_srInfo_input5);
//		this.formname.push("panel_srInfo_input5");
//		temp.push(this.formpanel_srInfo_input5);
//		temp.push(histroyForm);
		...
		this.model = "sr3_executeByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("sr3_executeByEngineer",this);
		if(this.readOnly!=1){
