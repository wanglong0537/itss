PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_tempRequire : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("temp_executeByEngineer","panel_tempRequire", this.dataId);// 这是要随时变得
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("temp_executeByEngineer",
...
//			loadMask : true,
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "temp_executeByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("temp_executeByEngineer",this);
