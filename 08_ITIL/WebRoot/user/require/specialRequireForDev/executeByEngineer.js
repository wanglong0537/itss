PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequireDevConfirm_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("devsr_executeByEngineer",
					"panel_SpecialRequireDevConfirm_Input", this.dataId);// 这是要随时变得
		} else {
			data = da
					.getPanelElementsForAdd("panel_SpecialRequireDevConfirm_Input");
		}
...
//			loadMask : true,
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "devsr_executeByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel(
				"devsr_executeByEngineer", this);
