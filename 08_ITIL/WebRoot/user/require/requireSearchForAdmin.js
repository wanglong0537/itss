PagePanel = Ext.extend(Ext.Panel, {
	...
	panelNode : function() {
		  var menu = new Ext.menu.Menu({
	        ...
	        id: 'mainMenu1',
	        items: [
//remove by zhangzy for 客户要求改变展示风格 in 20100121 start	        
//	            {
//	            	id : "tree3",
//	                text: '需求列表',
//	                iconCls:'search',
...
//	                handler:onItemClick
//	            },
//remove by zhangzy for 客户要求改变展示风格 in 20100121 end	        
	        {
	            	id : "tree5",
	                text: 'IT需求',
	                iconCls:'search',
...
//remove by zhangzy for 客户要求改变展示风格 in 20100121 end	        
        	...
        	//--------
	       	...
	       	//var menu=this.menu;
			if (node.id == "tree0") {
				tempJsp ="/user/require/report/requireApplyAllReport.jsp";
