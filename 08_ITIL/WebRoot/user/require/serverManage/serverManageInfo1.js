PageTemplates = Ext.extend(Ext.Panel, {
	...
	saveAndSubmit : function(){
		...
		Ext.Ajax.request({
			...
			params : {
				info : param,
				panel : 'panel_ServerManageInfoOne_input',
				model : 'serverManageInfo1'
			},
	...
	getFormpanel_ServerManage_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("serverManageInfo1",
	...
	getFormpanel_ServerManageInfoOne_input : function() {
		...
		if (this.getFormButtons.length != 0) {
			this.formpanel_ServerManageInfoOne_input = new Ext.form.FormPanel({
				...
				title : "<font color=red>服务器管理员处理信息</font>",
				items : biddata,
				buttons : this.getFormButtons
			});
		} else {
	...
	initComponent : function() {
		...
		this.model = "serverManageInfo1";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil
				.getButtonForModel("serverManageInfo1", this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
				height : 'auto',
