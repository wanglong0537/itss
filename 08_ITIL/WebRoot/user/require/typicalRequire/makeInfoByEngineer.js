PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_typicalRequire_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("tr_makeInfoByEngineer","panel_typicalRequire_Input", this.dataId);// 这是要随时变得
	...
	getFormpanel_srInfo_input1 : function() {
		...
		this.getFormButtons = buttonUtil.getButtonForPanel("panel_srInfo_input1",
				this);
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("tr_makeInfoByEngineer","panel_srInfo_input1", this.dataId);// 这是要随时变得
	...
	initComponent : function() {
		...
		this.model = "tr_makeInfoByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("tr_makeInfoByEngineer",
				this);
