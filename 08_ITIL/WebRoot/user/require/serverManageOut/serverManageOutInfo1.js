...
//		 alert(param); //************************************显示面板保存的数据************************************
		Ext.Ajax.request({
			...
			params : {
				info : param,
				panel : 'panel_ServerManageOutInfoOne_input',
				model : 'serverManageOutInfo1'
			},
	...
	getFormpanel_ServerManageOut_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("serverManageOutInfo1",
	...
	getFormpanel_ServerPanel : function(id) {
		...
		if (id == 0) {
			...
			data = da
					.getSingleFormPanelElementsForEdit("panel_ServerPanel", id);
		}
		biddata = da.splitForReadOnly(data);
	...
	initComponent : function() {	
		...
		this.model = "serverManageOutInfo1";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("serverManageOutInfo1",
				this);
