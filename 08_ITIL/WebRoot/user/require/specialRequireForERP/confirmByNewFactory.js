PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_erpSR_it_input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("esr_confirmByNewFactory",
...
//		biddata = da.split(modifyData);
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "esr_confirmByNewFactory";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("esr_confirmByNewFactory", this);
