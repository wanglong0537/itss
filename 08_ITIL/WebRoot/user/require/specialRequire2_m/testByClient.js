PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequire4_m_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("sr2_m_testByClient",
...
//add by lee for add attachmentfile in 20090806 begin
	...
	initComponent : function() {
		...
		this.model = "sr2_m_testByClient";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("sr2_m_testByClient", this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
				height : 'auto',
...
//		temp.push(this.gridflm_projectPlanList);
		...
		this.on("workflowForSubmit",this.workflowForSubmit,this);
