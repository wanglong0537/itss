PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequire4_m_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("sr2_m_transmitByEngineer",
	...
	//			if (this.dataId != '0') {
	//				data = da.getPanelElementsForEdit("sr2_m_transmitByEngineer", "panel_SRProjectPlan", this.dataId);// 这是要随时变得
	//				biddata = da.split(data);
	//			} else {
...
//		}
	...
	initComponent : function() {
		...
		this.model = "sr2_m_transmitByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("sr2_m_transmitByEngineer",
				this);
		if (this.mybuttons != "") {
			this.buttons = {
				layout : 'table',
