PageTemplates = Ext.extend(Ext.Panel, {
	...
	getFormpanel_SpecialRequire4_m_Input : function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("sr2_m_end","panel_SpecialRequire4_m_Input", this.dataId);// 这是要随时变得
	...
	getFormpanel_SRAnalyse2 : function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("sr2_m_end","panel_SRAnalyse2", this.dataId);// 这是要随时变得
	...
	getFormpanel_SRTransmisEngineer : function() {
		...
		var biddata = "";
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("sr2_m_end","panel_SRTransmisEngineer", this.dataId);// 这是要随时变得
	...
	initComponent : function() {
		...
		this.model = "sr2_m_end";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("sr2_m_end",
				this);
