...
//申请主面板	
 getFormpanel_SpecialRequireDevConfirm_m_Input : function() {
		...
		if (this.dataId != '0') {
			data = da.getPanelElementsForEdit("devsr_m_makeInfoByEngineer",
...
//   
//		var cm = new Ext.grid.ColumnModel([{header:'id',dataIndex:'id',hidden:true,sortable:true},
...
//				url : webContext
//						+'/ciRelationShip_getModifyInfoListByProblemId.action?objectId='+this.dataId+"&modifyType=specialRequire",
...
//        var backUrl='/user/require/specialRequireForDev/makeInfoByEngineer.jsp?dataId='+this.dataId;
//        if(status!="草稿"){
//	        window.location =  webContext+ '/user/configNewModify/seeBatchModify.jsp?dataId='+modifyId+"&backUrl="+backUrl+'&modifyType=specialRequire';
//   		}else{
//   			window.location = webContext+'/user/configNewModify/configNewModify.jsp?modifyObjectId='+this.dataId+"&modifyType=specialRequire&dataId="+modifyId+"&backUrl="+backUrl;
//   		}
//        
//   },
...
//				collapsible : true,
	...
	ciModify:function(){
		var backUrl='/user/require/specialRequireForDev/makeInfoByEngineer.jsp?dataId='+this.dataId;
		window.location = webContext+'/user/configNewModify/configNewModify.jsp?modifyObjectId='+this.dataId+"&modifyType=specialRequire&backUrl="+backUrl;
	},
  items : this.items,
  buttons : this.buttons,
	...
	initComponent : function() {
		...
		var items = new Array();
		var temp = new Array();
		this.model = "devsr_m_makeInfoByEngineer";
		var buttonUtil = new ButtonUtil();
		this.mybuttons = buttonUtil.getButtonForModel("devsr_m_makeInfoByEngineer", this);
		this.buttons = this.mybuttons;
		temp.push(this.getFormpanel_SpecialRequireDevConfirm_m_Input());
		temp.push(this.getFormpanel_srInfo_input1());
		temp.push(this.getFormserviceItemBasePanel());
