	        ...
	        items:[
	            ...
	            autoLoad : {
					url : webContext + "/tabFrame.jsp?url=" + webContext
							+ "/user/knowledge/knowledgeChangeManager/knowledgeChangeManager.jsp",
					text : "页面正在加载中......",
					method : 'post',
					scope : this
					}
	            ...
	            autoLoad : {
					url : webContext + "/tabFrame.jsp?url=" + webContext
							+ "/user/knowledge/knowledgeChangeManager/knowFileChangeManager.jsp",
					text : "页面正在加载中......",
					method : 'post',
					scope : this
					}
	            ...
	            autoLoad : {
					url : webContext + "/tabFrame.jsp?url=" + webContext
							+ "/user/knowledge/knowledgeChangeManager/knowContractChangeManager.jsp",
					text : "页面正在加载中......",
					method : 'post',
					scope : this
					}
