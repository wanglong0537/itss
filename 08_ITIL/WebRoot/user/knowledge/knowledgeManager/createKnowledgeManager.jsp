...
<head> 
  <title>欢迎使用IT服务系统</title>   
    <%@include file="/includefiles.jsp"%>  	  
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/knowledge/knowledgeManager/createKnowledgeManager.js"></script>  
	<style type="text/css">  
		.x-head{ 
	...
	Ext.BLANK_IMAGE_URL = webContext+'/extEngine/resources/images/default/s.gif';
	   ...
	   var pagePanel = new PagePanel({panel: "${param.panel}",knowLedgeTypeId :"${param.knowLedgeTypeId}"});
