PageTemplates = Ext.extend(Ext.Panel, {
	...
	getTabpanel : function(tab, tabTitle) {
		this.tabPanel = new Ext.TabPanel({
			...
			items : tab,
			tbar : [new Ext.Toolbar.TextItem('<font color=red>提示：</font><font color=blue><font color=red>审批时要严格授权</font>，如果单据审核不通过，请点击页面下方的<font color=red>“审批”</font>按钮后在弹出窗口中</font>')]
	...
	getFormpanel_PersonAccountApply_Input : function() {
		...
		this.formpanel_PersonAccountApply_Input = new Ext.form.FormPanel({
			...
			{
				html : '<font color=red>*</font> 注册服务权限描述：为了能准确反馈您需要的权限，准备了一个权限注册描述事例，请按照该方式填写：<br>((例如：我在北京平台系统科技公司XXX事业部，希望查看XXX事业部销售、欠款等数据))',
				cls : 'common-text',
				colspan : 2,
				rowspan : 0,
