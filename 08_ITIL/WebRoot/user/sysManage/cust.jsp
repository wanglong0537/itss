...
<head>
  <title>欢迎使用IT服务系统</title>
    <%@include file="/includefiles.jsp"%>   	    
  	<script type="text/javascript" src="${pageContext.request.contextPath}/user/sysManage/CustApplyPanel.js"></script>
	...
	Ext.onReady(function(){	
	   ...
	   var cusApplayPanel = new CusApplayPanel();
	   
	   cusApplayPanel.render("Customer");
	   
	   new Ext.Viewport({
	   	 layout:'fit',
	   	 items:[cusApplayPanel]
	   });
