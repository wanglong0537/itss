...
function returnTableDetail(){
  window.location.href="${pageContext.request.contextPath}/serviceItem_columnInfo.action?dataId=${serviceItem.id}";
} 
...
<TABLE cellSpacing=1 cellPadding=3 width="100%" bgColor=#6298e1 border=0 height="56">
 ...
 <form action="${pageContext.request.contextPath}/serviceItem_saveScidColumn.action" method=post  name="editForm" id="editForm">
字段属性
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td align="center" bgcolor="#EFF3FF">字段名称</td>
    <td bgcolor="#EFF3FF">
    <input name="serviceItemType" id="serviceItemType"  type="hidden" value="${serviceItem.serviceItemType.id}">
  ...
  <!-- 
  <tr>
    <td align="center" bgcolor="#EFF3FF">唯一标识字段</td>
    <td bgcolor="#EFF3FF">
