...
<head>
  ...
  <%@include file="/includefiles.jsp"%>
    <META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=utf-8">    	  	
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/systemAdmin/platFormHRSign.js"></script>	  
	<style type="text/css"> 
		.x-head{
    ...
    Ext.onReady(function(){	
		  ...
		  modLoader.addModule('${pageContext.request.contextPath}/infoAdmin/systemAdmin/platFormHRSign.js', 'Page');
