...
<head>
  ...
  <%@include file="/includefiles.jsp"%>
    <META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=utf-8">  	
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/idgen/tableIdGenForm.js"></script> 
	<style type="text/css"> 
		.x-head{
	    ...
	    .nav {
	        background-image:url(resource/images/other/folder_go.png);
	    }
	    .cls {
	    	font-size:9pt;
	    }
	...
	Ext.onReady(function(){	
	   ...
	   if("${param.recordId}"==""){
	     var pageTemplates = new PageTemplates({dataId:"0",recordId:"${param.recordId}",isUpdate:"${param.isUpdate}",configItemTypeId:citId});
	   }
	   else{
	   var pageTemplates = new PageTemplates({dataId:"${param.dataId}",recordId:"${param.recordId}",isUpdate:"${param.isUpdate}",configItemTypeId:citId});
	   }
