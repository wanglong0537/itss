...
ListProcessPanel = Ext.extend(Ext.Panel, {
	...
	getCombValue : function(com, record) {
		...
		var value = record.get("departName") + '_' + realProcessDesc + "_["
				+ version + "]";
		Ext.getCmp('com.zsgj.writeInfo').getForm()
	...
	addVirtualProcess : function() {
		...
		var win = new Ext.Window({
			...
			buttons : [{
				...
				iconCls : 'save',
				handler : function() {
					var processType = Ext.getCmp('com.zsgj.writeInfo')
							.getForm().findField('definitionType').getValue();
					var department = Ext.getCmp('com.zsgj.writeInfo')
					...
					var ruleFile = Ext.getCmp('com.zsgj.writeInfo')
