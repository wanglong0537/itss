  ...
  <title>流程监控</title> 
	...
	<script type="text/javascript" src="<c:url value="/js/TabCloseMenu.js"/>"></script> 
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/actionConfigUnit.js"></script>
  	  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/processMonitorDetail.js"></script>
	<style type="text/css">  
		.x-head{ 
	...
	function updateTab(id,title, url) {
	   ...
	   var processMonitorDetailGridPanel = new ProcessMonitorDetailGridPanel();
	   
	   processMonitorDetailGridPanel.render("processMonitorDetailGridPanel");
	   
	   new Ext.Viewport({
	     
	   	 layout:'fit',
	   	 items:[processMonitorDetailGridPanel]
	   });
	});
...
<div id="processMonitorDetailGridPanel" style="height:100%"></div>
