...
<html>
	<head>
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/infoAdmin/workflow/configPage/taskInfoPanel.js"></script>
		<script type="text/javascript"
...
.common-text {
	...
	<script type="text/javascript">
		var vProcessId = "${param.virtualDefinitionInfoId}";
	</script>
		<script type="text/javascript">
	...
	Ext.onReady(function(){	
	   ...
	   var taskInfoPanel = new TaskInfoPanel({virtualDefinitionInfoId:'${param.virtualDefinitionInfoId}'});
	   
	   taskInfoPanel.render("orderConfirm");
	...
	<body onload="changeSkin('${userInfo.userViewStyle}');">
		<div id="orderConfirm" style="height: 100%"></div>
