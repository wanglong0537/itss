...
function selectTable(serviceItemId){
	 document.location.href="${pageContext.request.contextPath}/infoAdmin/serviceItemUserTableAction.do?methodCall=selectTable&serviceItemId="+serviceItemId;
}
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
 <form name="editForm" id="editForm" action="${pageContext.request.contextPath}/infoAdmin/serviceItemUserTableAction.do" method=post>
  ...
  <tr>  
  	<td width="10%" align="center" bgcolor="#EFF3FF">所属服务项</td>
    <td width="40%" bgcolor="#EFF3FF">${serviceItem.name}</td>
  ...
  <tr>
    ...
    <input name="serviceItem"  id="serviceItem"   type="hidden" value="${serviceItem.id}">
      <input name="tableName" id="tableName"  type="text" class="textfield" style="WIDTH:250px;" value="${siut.systemMainTable.tableName}">
    <input class=button type="button"  onclick="selectTable(${serviceItem.id});" value="选择已有需求主表">&nbsp;
    <br>
    </td>
...
<TABLE cellSpacing=1 cellPadding=3 width="100%" bgColor=#6298e1 border=0>
  <FORM name="formDel" action="${pageContext.request.contextPath}/infoAdmin/userMainTableColumn.do" method="post">
    ...
    <input type="hidden" name="smtId" value="${siut.systemMainTable.id}">
    <TBODY>
      <TR>
