...
<head>
  <title></title>
    ...
    <META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=utf-8">   	  	
  	...
  	<script type="text/javascript" src="${pageContext.request.contextPath}/infoAdmin/serviceItem/requireAppSystem.js"></script>	  
	<style type="text/css"> 
		.x-head{
    ...
    Ext.onReady(function(){	
		  ...
		  modLoader.addModule('${pageContext.request.contextPath}/infoAdmin/serviceItem/requireAppSystem.js', 'Page');
