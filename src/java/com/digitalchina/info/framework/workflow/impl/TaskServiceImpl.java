...
import com.digitalchina.info.framework.workflow.rules.ProcessRuleHelper;
...
public class TaskServiceImpl extends BaseDao implements TaskService {   
	...
	static 
	{
		log = LogFactory.getLog(com.digitalchina.info.framework.workflow.impl.TaskServiceImpl.class);
	}
	/**
	 * 任务接点执行任务
