...
import com.digitalchina.itil.require.entity.ProcessLockInfo;
import com.digitalchina.itil.require.entity.RequireAppSystem;
...
import com.digitalchina.itil.require.service.RequireSIService;
import com.digitalchina.itil.require.service.RequireService;
import com.digitalchina.itil.requireErp.synchronize.SAPExecute;
...
public class RequireAction extends BaseAction {
	...
	public String toRequireInfo() {
		...
		request.setAttribute("tableName", tableName);// "com.digitalchina.itil.service.entity.ServiceItem");//
		return "requireInfo";
	}
...
//		}
	...
	public String saveDraft(){
		...
		// *******生成服务项时同时生成主项目计划
		String name = (String) map.get("name");
		if ("com.digitalchina.itil.require.entity.SpecialRequirement".equals(className)){
