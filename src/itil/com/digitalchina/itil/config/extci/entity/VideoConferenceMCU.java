...
public class VideoConferenceMCU extends BaseObject {
   ...
   private com.digitalchina.itil.config.extlist.entity.VideoConfMCUType videoConfMCUType;
...
public com.digitalchina.itil.config.extlist.entity.VideoConfMCUType getVideoConfMCUType() {
	return videoConfMCUType;
}
public void setVideoConfMCUType(
		com.digitalchina.itil.config.extlist.entity.VideoConfMCUType videoConfMCUType) {
	this.videoConfMCUType = videoConfMCUType;
}
} 
