...
public class SecurityDevice extends BaseObject {
   ...
   private com.digitalchina.itil.config.extlist.entity.SecurityDeviceType securityDeviceType;

   public com.digitalchina.itil.config.extlist.entity.SecurityDeviceType getSecurityDeviceType() {
	return securityDeviceType;
}
public void setSecurityDeviceType(
		com.digitalchina.itil.config.extlist.entity.SecurityDeviceType securityDeviceType) {
...
public void setId(java.lang.Long id){
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.digitalchina.itil.config.extci.entity.SecurityDevice other = (com.digitalchina.itil.config.extci.entity.SecurityDevice) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
