...
public class DataCenterEvent extends BaseObject {
   private com.digitalchina.itil.config.extci.entity.OfficeLocation officeLocation;
   private java.lang.Integer floor;
   private com.digitalchina.itil.config.extlist.entity.DataCenterType type;
   ...
   public void setOfficeLocation(com.digitalchina.itil.config.extci.entity.OfficeLocation officeLocation){
	     this.officeLocation=officeLocation;
   }
   public void setFloor(java.lang.Integer floor){
	     this.floor=floor;
   }
   public void setType(com.digitalchina.itil.config.extlist.entity.DataCenterType type){
	     this.type=type;
   }
   ...
   public com.digitalchina.itil.config.extci.entity.OfficeLocation getOfficeLocation(){
	     return this.officeLocation;
   }
   public java.lang.Integer getFloor(){
	     return this.floor;
   }
   public com.digitalchina.itil.config.extlist.entity.DataCenterType getType(){
	     return this.type;
   }
