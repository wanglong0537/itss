...
public class SRNotice extends BaseObject {
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.digitalchina.itil.config.extlist.entity.SRNotice other = (com.digitalchina.itil.config.extlist.entity.SRNotice) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
