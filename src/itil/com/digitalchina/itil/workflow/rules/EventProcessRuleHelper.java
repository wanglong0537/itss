...
//			event.setDealuser(event.getSubmitUser());
		...
		if(result.equals("touserconfirm")){//审批历史保存后再发送邮件
			...
			String url = PropertiesUtil.getProperties("system.web.url","itss.digitalchina.com") + "/user/event/transactionFlow/userconfirm.jsp?dataId="+dataId+"&processId="+processId;
