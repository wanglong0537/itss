...
public class MailGroup extends BaseObject {
	...
	private com.zsgj.itil.config.extlist.entity.MailGroup oldApply;
	...
	public void setOldApply(
			com.zsgj.itil.config.extlist.entity.MailGroup oldApply) {
	...
	public com.zsgj.itil.config.extlist.entity.MailGroup getOldApply() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final com.zsgj.itil.config.extlist.entity.MailGroup other = (com.zsgj.itil.config.extlist.entity.MailGroup) obj;
		if (id == null) {
			if (other.id != null)
				return false;
