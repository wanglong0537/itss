...
public class BIdataServiceEvent extends BaseObject {
   ...
   public void setServiceType(com.zsgj.itil.config.extlist.entity.BIServiceType serviceType){
   ...
   public boolean equals(Object obj) {
   	...
   	if (getClass() != obj.getClass())
   		return false;
   	final com.zsgj.itil.config.extci.entity.BIdataServiceEvent other = (com.zsgj.itil.config.extci.entity.BIdataServiceEvent) obj;
   	if (id == null) {
   		if (other.id != null)
   			return false;
