...
public class OfficeLocation extends BaseObject {
   ...
   private com.zsgj.itil.config.extlist.entity.OfficeLocationType type;
   ...
   public void setType(com.zsgj.itil.config.extlist.entity.OfficeLocationType type){
	     this.type=type;
   }
   ...
   public com.zsgj.itil.config.extlist.entity.OfficeLocationType getType(){
	     return this.type;
   }
