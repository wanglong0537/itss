...
//import com.zsgj.info.appframework.metadata.service.SystemExtColumnServcie;
...
public class SerivceItemUserTableColumnAction extends BaseDispatchAction{
	...
	public ActionForward toForm(ActionMapping mapping,
		...
		String siutId = request.getParameter("siut");
		request.setAttribute("serviceItem", serviceItem);
		request.setAttribute("siut", siutId);
...
//	}
	...
	public ActionForward save(ActionMapping mapping,
		...
		return HttpUtil.redirect("serviceItemUserTableAction.do?methodCall=addTable&serviceItemId="+serviceItem);
...
//		return HttpUtil.redirect("serviceItemUserTableColumn.do?methodCall=toForm&id="+mainTableId);
//	}
	...
	public ActionForward remove(ActionMapping mapping,
		...
		return HttpUtil.redirect("serviceItemUserTableColumn.do?methodCall=toForm&id="+smtId+"&pageNo="+pageNo); //+pageNo+"&level="+level
	}
