 ...
 * @Create In 2008-11-9
 */
public class ServiceCatalogueEvent extends BaseObject{
	...
	public static int STATUS_ALTER_DRAFT = 10;// 草稿
...
//	}
	...
	public boolean equals(Object obj){
		...
		if (getClass() != obj.getClass())
			return false;
		final ServiceCatalogueEvent other = (ServiceCatalogueEvent)obj;
		if(id==null){
			if(other.id!=null)
				return false;
	...
	public Long getServiceCatalogue() {
		return serviceCatalogue;
	}
	public void setServiceCatalogue(Long serviceCatalogue) {
		this.serviceCatalogue = serviceCatalogue;
	}
	public Long getOldServiceCataId() {
		return oldServiceCataId;
	}
	public void setOldServiceCataId(Long oldServiceCataId) {
		this.oldServiceCataId = oldServiceCataId;
	}
