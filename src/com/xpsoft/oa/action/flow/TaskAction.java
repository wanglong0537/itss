...
public class TaskAction extends BaseAction {
	...
	public String list() {
		/* 45 */PagingBean pb = new PagingBean(this.start.intValue(),
				this.limit.intValue());
		/* 46 */List tasks = this.flowTaskService.getTaskInfosByUserId(
				ContextUtil.getCurrentUserId().toString(), pb);

		/* 48 */StringBuffer buff = new StringBuffer(
				"{success:true,'totalCounts':")
		/* 49 */.append(pb.getTotalItems()).append(",result:");

		/* 51 */Gson gson = new GsonBuilder().setDateFormat(
	...
	public String change() {
		...
		/* 67 */if ((task != null) && (curUserId.equals(task.getAssignee()))) {
			...
			/* 70 */if (StringUtils.isNotEmpty(msg)) {
				/* 72 */this.shortMessageService.save(AppUser.SYSTEM_USER,
						userId, msg, ShortMessage.MSG_TYPE_TASK);
			}
		}
	...
	public String lock() {
		...
		/* 108 */if ((task != null) && (task.getAssignee() == null)) {
			/* 109 */this.taskService.assignTask(task.getId(), ContextUtil
	...
	public String display() {
		...
		/* 121 */List tasks = this.flowTaskService.getTaskInfosByUserId(
				ContextUtil.getCurrentUserId().toString(), pb);
	...
	public String check() {
		...
		/* 135 */if ((task != null) && (task.getAssignee() != null)
