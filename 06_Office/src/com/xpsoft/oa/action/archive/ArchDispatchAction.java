...
/* 113 */     filter.addFilter("Q_userId_L_EQ", ContextUtil.getCurrentUserId()
/* 114 */       .toString());
/* 115 */     List list = this.archDispatchService.getAll(filter);
/*     */ 
/* 118 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
/* 119 */       .append(filter.getPagingBean().getTotalItems()).append(
/* 120 */       ",result:");
/*     */ 
/* 124 */     JSONSerializer serializer = JsonUtil.getJSONSerializer(new String[] { "dispatchTime", "archives.issueDate", "archives.createtime" });
...
/* 141 */     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
/* 142 */       .append(pb.getTotalItems()).append(",result:");
/*     */ 
/* 144 */     JSONSerializer serializer = JsonUtil.getJSONSerializer(new String[] { "dispatchTime" });
...
/*     */   public String get()
/*     */   {
/* 178 */     ArchDispatch archDispatch = (ArchDispatch)this.archDispatchService.get(this.dispatchId);
/*     */ 
...
/*     */   public String save()
/*     */   {
/* 194 */     Archives archives = (Archives)this.archivesService.get(this.archivesId);
...
/*     */       } else {
/* 212 */         String signUserIds = getRequest().getParameter("undertakeUserIds");
/* 213 */         String cruArchDepId = getRequest().getParameter("cruArchDepId");
/* 214 */         if (StringUtils.isNotEmpty(signUserIds)) {
/* 215 */           String[] signId = signUserIds.split(",");
/* 216 */           int size = signId.length;
/* 217 */           if (size < 2) {
/* 218 */             if ((this.archUserType.compareTo(ArchDispatch.IS_UNDERTAKE) == 0) && 
/* 219 */               (StringUtils.isNotEmpty(cruArchDepId)) && (cruArchDepId.indexOf("$") == -1)) {
/* 220 */               ArchivesDep archivesDep = (ArchivesDep)this.archivesDepService.get(new Long(cruArchDepId));
/* 221 */               StringBuffer sb = new StringBuffer("<div>" + this.readFeedback);
/* 222 */               SimpleDateFormat sdf = new SimpleDateFormat();
/* 223 */               sdf.format(new Date());
/* 224 */               sb.append("--").append(ContextUtil.getCurrentUser().getFullname()).append("--").append(sdf.format(new Date())).append("</div>");
/* 225 */               archivesDep.setHandleFeedback(sb.toString());
/* 226 */               this.archivesDepService.save(archivesDep);
/*     */             }
/*     */ 
/* 229 */             archives.setStatus(Archives.STATUS_END);
/*     */           } else {
/* 231 */             int recordSize = this.archDispatchService.countArchDispatch(archives.getArchivesId());
/* 232 */             if ((this.archUserType.compareTo(ArchDispatch.IS_UNDERTAKE) == 0) && 
/* 233 */               (StringUtils.isNotEmpty(cruArchDepId)) && (cruArchDepId.indexOf("$") == -1)) {
/* 234 */               ArchivesDep archivesDep = (ArchivesDep)this.archivesDepService.get(new Long(cruArchDepId));
/* 235 */               StringBuffer sb = new StringBuffer();
/* 236 */               if (archivesDep.getHandleFeedback() != null) {
/* 237 */                 sb.append(archivesDep.getHandleFeedback());
/*     */               }
/* 239 */               sb.append("<div>" + this.readFeedback);
/* 240 */               SimpleDateFormat sdf = new SimpleDateFormat();
/* 241 */               sdf.format(new Date());
/* 242 */               sb.append("--").append(ContextUtil.getCurrentUser().getFullname()).append("--").append(sdf.format(new Date())).append("</div>");
/* 243 */               archivesDep.setHandleFeedback(sb.toString());
...
/*     */             else {
/* 250 */               archives.setStatus(Archives.STATUS_READING);
/*     */             }
/*     */           }
/*     */         }
...
/*     */   public String read()
/*     */   {
/* 267 */     ArchDispatch archDispatch = (ArchDispatch)this.archDispatchService.get(this.dispatchId);
...
/* 287 */     Archives archives = (Archives)this.archivesService.get(this.archivesId);
/* 288 */     if (archives != null) {
/* 289 */       if (StringUtils.isNotEmpty(disUserIds)) {
/* 290 */         String[] ids = disUserIds.split(",");
/* 291 */         for (String id : ids) {
/* 292 */           AppUser appUser = (AppUser)this.appUserService.get(new Long(id));
...
/* 300 */           archDispatch.setArchUserType(ArchDispatch.IS_DISPATCH);
...
/* 307 */           AppRole role = (AppRole)this.appRoleService.get(new Long(id));
...
/* 315 */           archDispatch.setArchUserType(ArchDispatch.IS_DISPATCH);
...
/*     */   {
/* 332 */     ArchDispatch archDispatch = (ArchDispatch)this.archDispatchService.get(this.dispatchId);
 ...
 * Qualified Name:     com.xpsoft.oa.action.archive.ArchDispatchAction
