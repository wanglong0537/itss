...
public class NoticeNewsComment extends BaseModel {
	...
	protected Integer flag;//1,为评论，2，为阅读

	public NoticeNewsComment() {
	}

	public NoticeNewsComment(Long in_commentId) {
	...
	public void setNews(NoticeNews in_news) {
	...
	public void setNewsId(Long aValue) {
		/* 88 */if (aValue == null) {
			...
			/* 91 */this.news = new NoticeNews(aValue);
	...
	public boolean equals(Object object) {
		/* 171 */if (!(object instanceof NoticeNewsComment)) {
			/* 172 */return false;
		}
		/* 174 */NoticeNewsComment rhs = (NoticeNewsComment) object;
