				...
				columns : [
						...
						},
						{
							...
							renderer : function(n) {
								var o = "";
								if (n == "1") {
									o += '<img title="激活" src="' + __ctxPath + '/images/flag/customer/effective.png"/>';
								} else {
									o += '<img title="禁用" src="' + __ctxPath + '/images/flag/customer/invalid.png"/>';
								}
								return o;
							}
						},
						...
						},
						{
							...
							renderer : function(r, q, o, u, p) {
								...
								if (isGranted("_AppUserDel") && t != 1) {
									s += '<button title="删除" value=" " class="btn-del" onclick="DepartmentView.remove(' + t + ')"></button>';
								}
